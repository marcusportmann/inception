...
@XmlRootElement(name = "PartyAttributeType", namespace = "http://reference.inception.digital")
@XmlType(
    name = "PartyAttributeType",
    namespace = "http://reference.inception.digital",
    propOrder = {"code", "category", "localeId", "sortIndex", "name", "description"})
@XmlAccessorType(XmlAccessType.FIELD)
@Entity
@Table(schema = "reference", name = "party_attribute_types")
