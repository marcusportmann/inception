...
/**
 * The <code>TimeToContactId</code> class implements the ID class for the <code>TimeToContact</code>
 * class.
 *
...
public class TimeToContactId implements Serializable {
  ...
  /** Constructs a new <code>TimeToContactId</code>. */
  ...
  public boolean equals(Object object) {
    ...
    TimeToContactId other = (TimeToContactId) object;
   ...
   *
   * @param locale the Unicode locale identifier for the time to contact
   */
