...
/**
 * The <code>SuitableTimeToContact</code> class holds the information for a possible suitable time
 * to contact.
 *
 * @author Marcus Portmann
 */
@Schema(description = "A suitable time to contact")
...
@IdClass(SuitableTimeToContactId.class)
public class SuitableTimeToContact {

  /** The code for the suitable time to contact. */
  @Schema(description = "The code for the suitable time to contact", required = true)
  ...
  @Schema(description = "The description for the suitable time to contact", required = true)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The sort index for the suitable time to contact", required = true)
  @JsonProperty(required = true)
  ...
  /** Constructs a new <code>SuitableTimeToContact</code>. */
  public SuitableTimeToContact() {}
  ...
  /**
   * Returns the description for the suitable time to contact.
   *
   * @return the description for the suitable time to contact
   */
  ...
  /**
   * Returns the name of the suitable time to contact.
   *
   * @return the name of the suitable time to contact
   */
  ...
  /**
   * Returns the sort index for the suitable time to contact.
   *
   * @return the sort index for the suitable time to contact
   */
  ...
  /**
   * Set the description for the suitable time to contact.
   *
  ...
  /**
   * Set the name of the suitable time to contact.
   *
  ...
  /**
   * Set the sort index for the suitable time to contact.
   *
