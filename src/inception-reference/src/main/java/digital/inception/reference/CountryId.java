...
/**
 * The <code>CountryId</code> class implements the ID class for the <code>Country</code> class.
 *
...
public class CountryId implements Serializable {
  ...
  /** Constructs a new <code>CountryId</code>. */
  public CountryId() {}
   ...
   */
  public CountryId(String code, String locale) {
    this.code = code;
    this.locale = locale;
  }
