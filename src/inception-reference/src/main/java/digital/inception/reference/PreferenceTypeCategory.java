...
/**
 * The <code>PreferenceTypeCategory</code> class holds the information for a possible preference
 * type category.
 *
 * @author Marcus Portmann
 */
@Schema(description = "A collection of related preference types for a person")
...
public class PreferenceTypeCategory implements Serializable {
  ...
  /** Constructs a new <code>PreferenceTypeCategory</code>. */
