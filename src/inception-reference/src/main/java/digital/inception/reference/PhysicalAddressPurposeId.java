...
/**
 * The <code>PhysicalAddressPurposeId</code> class implements the ID class for the <code>
 * PhysicalAddressPurpose</code> class.
 *
...
public class PhysicalAddressPurposeId implements Serializable {
  ...
  /** Constructs a new <code>PhysicalAddressPurposeId</code>. */
   ...
   *
   * @param locale the Unicode locale identifier for the physical address purpose
   */
