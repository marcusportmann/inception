...
/**
 * The <code>PreferenceTypeCategoryId</code> class implements the ID class for the <code>PreferenceTypeCategory</code> class.
 *
...
public class PreferenceTypeCategoryId implements Serializable {
  ...
  /** Constructs a new <code>PreferenceTypeCategoryId</code>. */
   ...
   *
   * @param locale the Unicode locale identifier for the preference type category
   */
