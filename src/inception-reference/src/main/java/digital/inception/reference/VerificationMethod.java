...
/**
 * The <b>VerificationMethod</b> class holds the information for a possible verification method.
 *
...
@XmlRootElement(name = "VerificationMethod", namespace = "http://inception.digital/reference")
@XmlType(
...
public class VerificationMethod implements Serializable {
  ...
  /** Constructs a new <b>VerificationMethod</b>. */
