...
/**
 * The <b>MessagingServiceException</b> exception is thrown to indicate an error condition
 * when working with the Messaging Service.
 *
...
@WebFault(
    name = "MessagingServiceException",
...
public class MessagingServiceException extends ServiceException {
  ...
  /**
   * Constructs a new <b>MessagingServiceException</b> with the specified message.
   *
  ...
  /**
   * Constructs a new <b>MessagingServiceException</b> with the specified message and cause.
   *
   * @param message The message saved for later retrieval by the <b>getMessage()</b> method.
