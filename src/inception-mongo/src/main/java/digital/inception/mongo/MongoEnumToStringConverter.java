...
//
/// **
// * The <b>MongoEnumToStringConverter</b> class implements a custom WritingConverter, which
// converts
// * Enum values to String values using the Jackson approach. This approach uses the
// * {@code @JsonValue} annotation on a method on the custom Enum class. If this is not possible,
// the
...
//
//  /**
//   * Finds a method annotated with {@code @JsonValue} in the given enum class. The result
// (including
