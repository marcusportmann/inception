...
/**
 * The <b>MongoStringToEnumConverterFactory</b> class implements a custom ReadingConverter factory,
    ...
    return new Converter<String, T>() {
      ...
      public T convert(String source) {
        ...
        try {
          ...
          String methodUsed =
              enumConversionMethods.jsonCreatorMethod() != null ? "JsonCreator" : "valueOf(String)";
          throw new IllegalStateException(
