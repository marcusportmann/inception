...
/**
 * The <b>PartyApiController</b> class.
 *
 * @author Marcus Portmann
 */
@RestController
@CrossOrigin
public class PartyApiController extends SecureApiController implements IPartyApiController {
   ...
   */
  public PartyApiController(ApplicationContext applicationContext, IPartyService partyService) {
