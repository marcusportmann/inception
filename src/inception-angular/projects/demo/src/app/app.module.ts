  ...
  protected initNavigation(): NavigationItem[] {
    ...
    navigation.push(
      new NavigationItem(
        ...
        'Dashboard',
        '/dashboard',
        ['ROLE_Administrator', 'FUNCTION_Dashboard.Dashboard'],
        undefined,
        undefined,
        undefined,
          ...
          new NavigationItem(
            ...
            [
              ...
              new NavigationItem(
                'fa fa-table',
                'Sortable Table',
                '/inception/tables/sortable-table',
                []
              )
            ]
          )
              ...
              new NavigationItem(
                ...
                [
                  new NavigationItem(
                    'fas fa-cogs',
                    'Jobs',
                    '/administration/system/scheduler/jobs',
                    [
                      'ROLE_Administrator',
                      'FUNCTION_Scheduler.SchedulerAdministration',
                      'FUNCTION_Scheduler.JobAdministration'
