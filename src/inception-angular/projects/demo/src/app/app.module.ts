  ...
  protected initNavigation(): NavigationItem[] {
    ...
    navigation.push(new NavigationItem('fa fa-layer-group', 'Inception', '/inception', [], [
      ...
      new NavigationItem('fa fa-puzzle-piece', 'Components', '/inception/components', [], [
        ...
        new NavigationItem('fa fa-puzzle-piece', 'Error Report',
          '/inception/components/error-report'),
      ...
      new NavigationItem('fa fa-file-alt', 'Forms', '/inception/forms', [], [
        ...
        new NavigationItem('fa fa-file-alt', 'Reference Components',
          '/inception/forms/reference-components')]),
    ...
    navigation.push(new NavigationItem('fa fa-cogs', 'Administration', '/administration', [
      ...
      'FUNCTION_Error.ViewErrorReport', 'FUNCTION_Security.GroupAdministration',
      'FUNCTION_Security.TenantAdministration', 'FUNCTION_Security.ResetUserPassword',
      'FUNCTION_Security.UserAdministration', 'FUNCTION_Security.UserDirectoryAdministration',
      'FUNCTION_Security.UserGroups', 'FUNCTION_Scheduler.SchedulerAdministration',
      'FUNCTION_Scheduler.JobAdministration', 'FUNCTION_Mail.MailAdministration',
      ...
      new NavigationItem('fa fa-shield-alt', 'Security', '/administration/security', [
        ...
        'FUNCTION_Security.PolicyAdministration', 'FUNCTION_Security.TenantAdministration',
        ...
        new NavigationItem('far fa-address-book', 'User Directories',
        ...
        new NavigationItem('fas fa-circle-exclamation', 'Error Reports',
          '/administration/system/error-reports', [
