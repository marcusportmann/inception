  ...
  template: `
    <div matAutocompleteOrigin #origin="matAutocompleteOrigin">
      ...
      <mat-autocomplete
        ...
        <mat-option
          *ngFor="let industryClassificationSystem of filteredOptions$ | async"
...
export class IndustryClassificationSystemInputComponent implements MatFormFieldControl<string>,
   ...
   */
  filteredOptions$: BehaviorSubject<IndustryClassificationSystem[]> = new BehaviorSubject<IndustryClassificationSystem[]>([]);
  ...
  ngOnInit(): void {
    ...
    this.partyReferenceService.getIndustryClassificationSystems().pipe(first()).subscribe((industryClassificationSystems: Map<string, IndustryClassificationSystem>) => {
      this.subscriptions.add(this.inputValue$.pipe(
        ...
        this.filteredOptions$.next(filteredIndustryClassificationSystems);
      }));
    });
  }
