...
@Component({
  ...
  selector: 'contact-mechanism-role-input',
  template: `
  ...
  providers: [
    {
      ...
      useExisting: ContactMechanismRoleInputComponent
    }
  ]
})
export class ContactMechanismRoleInputComponent implements MatFormFieldControl<string>,
  ...
  /**
   * The reference to the element for the contact mechanism role input.
   */
  @ViewChild('contactMechanismRoleInput') contactMechanismRoleInputElementRef!: ElementRef;
   ...
   */
  controlType = 'contact-mechanism-role-input';

  /**
   * The filtered contact mechanism roles for the autocomplete.
   */
   ...
   */
  @HostBinding() id = `contact-mechanism-role-input-${ContactMechanismRoleInputComponent._nextId++}`;
  ...
  /**
   * The placeholder for the contact mechanism role input.
   * @private
   */
  ...
  /**
   * The code for the selected contact mechanism role.
   */
  private _value: string | null = null;

  /**
   * Returns the code for the selected contact mechanism role.
   *
   * @return the code for the selected contact mechanism role
   */
  ...
  /**
   * Set the code for the selected contact mechanism role.
   *
   * @param value the code for the selected contact mechanism role
   */
  @Input()
  ...
  onFocusOut(event: FocusEvent) {
    // If we have cleared the contactMechanismRole input then clear the value when losing focus
