  ...
  template: `
    <div matAutocompleteOrigin #origin="matAutocompleteOrigin">
      ...
      <mat-autocomplete
        ...
        <mat-option
          *ngFor="let contactMechanismRole of filteredOptions$ | async"
...
export class ContactMechanismRoleInputComponent implements MatFormFieldControl<string>,
   ...
   */
  filteredOptions$: BehaviorSubject<ContactMechanismRole[]> = new BehaviorSubject<ContactMechanismRole[]>([]);
  ...
  ngOnInit(): void {
    ...
    this.partyReferenceService.getContactMechanismRoles().pipe(first()).subscribe((contactMechanismRoles: Map<string, ContactMechanismRole>) => {
      this.subscriptions.add(this.inputValue$.pipe(
        ...
        this.filteredOptions$.next(filteredContactMechanismRoles);
      }));
    });
  }
