...
export class GenderInputComponent implements MatFormFieldControl<string>,
   ...
   */
  filteredOptions$: BehaviorSubject<Gender[]> = new BehaviorSubject<Gender[]>([]);
  ...
  ngOnInit(): void {
    ...
    this.partyReferenceService.getGenders().pipe(first()).subscribe((countries: Map<string, Gender>) => {
