  ...
  template: `
    <div matAutocompleteOrigin #origin="matAutocompleteOrigin">
      ...
      <mat-autocomplete
        ...
        <mat-option
          *ngFor="let preferenceTypeCategory of filteredOptions$ | async"
...
export class PreferenceTypeCategoryInputComponent implements MatFormFieldControl<string>,
   ...
   */
  filteredOptions$: BehaviorSubject<PreferenceTypeCategory[]> = new BehaviorSubject<PreferenceTypeCategory[]>([]);
