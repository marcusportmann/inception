  ...
  implements AfterContentInit, AfterContentChecked, AfterViewInit, OnDestroy
{
  ...
  /** Whether Angular animations are enabled. */
...
//
//       for (const item of checkboxChildren) {
//         if (!item.disabled) {
//           return false;
//         }
//       }
...
//     }
//
//     for (const item of startEls) {
//       item.style.width = `${startWidth}px`;
//     }
//     for (const item of gapEls) {
//       item.style.width = `${gapWidth}px`;
//     }
//
//     this._outlineGapCalculationNeededOnStable =
//       this._outlineGapCalculationNeededImmediately = false;
