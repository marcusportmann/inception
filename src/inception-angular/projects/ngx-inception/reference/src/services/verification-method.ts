...
/**
 * The VerificationMethod class holds the information for a verification method.
 *
...
export class VerificationMethod {
  ...
  /**
   * The abbreviation for the verification method.
   */
  abbreviation: string;
   ...
   * @param abbreviation The abbreviation for the verification method.
