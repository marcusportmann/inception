...
export class NewUserComponent extends AdminContainerView implements OnInit {
  ...
  readonly expiredPasswordControl: FormControl<boolean>;
  ...
  readonly newUserForm: FormGroup<{
    ...
    expiredPassword?: FormControl<boolean>;
    userLocked?: FormControl<boolean>;
  }>;
  ...
  readonly userLockedControl: FormControl<boolean>;
  ...
  constructor() {
    ...
    this.preferredNameControl = new FormControl<string | null>(null, {
