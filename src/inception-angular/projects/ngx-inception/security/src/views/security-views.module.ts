...
@NgModule({
  declarations: [
    // Components
    EditGroupComponent, EditPolicyComponent, EditTenantComponent, EditUserDirectoryComponent,
    EditUserComponent, GroupMembersComponent, GroupRolesComponent, GroupsComponent,
    InternalUserDirectoryComponent, LdapUserDirectoryComponent, NewGroupComponent,
    NewPolicyComponent, NewTenantComponent, NewTokenComponent, NewUserComponent,
    NewUserDirectoryComponent, PoliciesComponent, TenantsComponent, TenantUserDirectoriesComponent,
    TokenClaimDialogComponent, ResetUserPasswordComponent, SecurityOverviewComponent,
    TokensComponent, UserDirectoriesComponent, UserGroupsComponent, UserProfileComponent,
    UsersComponent, ViewTokenComponent],
  imports: [
    // Angular modules
  ...
  providers: [
    // Resolvers
    EditGroupTitleResolver, EditPolicyTitleResolver, EditTenantTitleResolver,
    EditUserDirectoryTitleResolver, EditUserTitleResolver, GroupMembersTitleResolver,
    GroupRolesTitleResolver, GroupTitleResolver, GroupsTitleResolver, NewGroupTitleResolver,
    NewPolicyTitleResolver, NewTenantTitleResolver, NewTokenTitleResolver,
    NewUserDirectoryTitleResolver, NewUserTitleResolver, PoliciesTitleResolver, PolicyTitleResolver,
    ResetUserPasswordTitleResolver, SecurityOverviewTitleResolver, TenantsTitleResolver,
    TenantTitleResolver, TenantUserDirectoriesTitleResolver, TokensTitleResolver,
    TokenTitleResolver, UserDirectoriesTitleResolver, UserDirectoryTitleResolver,
    UserGroupsTitleResolver, UsersTitleResolver, UserTitleResolver, ViewTokenTitleResolver]
})
