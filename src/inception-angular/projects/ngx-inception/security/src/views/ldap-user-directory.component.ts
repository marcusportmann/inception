...
export class LdapUserDirectoryComponent implements ControlValueAccessor, Validator {
  ...
  constructor() {
    ...
    this.supportsChangePasswordControl = new FormControl('', [
      Validators.required,
      Validators.pattern('^(true|false)$')
    ]);
    this.supportsGroupAdministrationControl = new FormControl('', [
      Validators.required,
      Validators.pattern('^(true|false)$')
    ]);
    this.supportsGroupMemberAdministrationControl = new FormControl('', [
      Validators.required,
      Validators.pattern('^(true|false)$')
    ]);
    this.supportsUserAdministrationControl = new FormControl('', [
      Validators.required,
      Validators.pattern('^(true|false)$')
    ]);
  ...
  setParameters(parameters: UserDirectoryParameter[]): void {
    ...
    this.groupMemberAttributeControl.setValue(
      UserDirectoryUtil.hasParameter(parameters, 'GroupMemberAttribute')
        ? UserDirectoryUtil.getParameter(parameters, 'GroupMemberAttribute')
        : 'member'
    );
    this.groupNameAttributeControl.setValue(
      UserDirectoryUtil.hasParameter(parameters, 'GroupNameAttribute')
        ? UserDirectoryUtil.getParameter(parameters, 'GroupNameAttribute')
        : 'cn'
    );
    ...
    this.groupObjectClassControl.setValue(
      UserDirectoryUtil.hasParameter(parameters, 'GroupObjectClass')
        ? UserDirectoryUtil.getParameter(parameters, 'GroupObjectClass')
        : 'groupOfNames'
    );
    ...
    this.userPhoneNumberAttributeControl.setValue(
      UserDirectoryUtil.hasParameter(parameters, 'UserPhoneNumberAttribute')
        ? UserDirectoryUtil.getParameter(parameters, 'UserPhoneNumberAttribute')
        : 'telephoneNumber'
    );
    this.userUsernameAttributeControl.setValue(
      UserDirectoryUtil.hasParameter(parameters, 'UserUsernameAttribute')
        ? UserDirectoryUtil.getParameter(parameters, 'UserUsernameAttribute')
        : 'uid'
    );
