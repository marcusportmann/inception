 ...
 * title for the "Organizations" route in the navigation hierarchy.
 *
...
export class OrganizationsTitleResolver implements Resolve<string> {
  ...
  /**
   * Constructs a new OrganizationsTitleResolver.
   */
  constructor() {
  }
  ...
  resolve(activatedRouteSnapshot: ActivatedRouteSnapshot,
    ...
    return of($localize`:@@security_organizations_title_resolver:Organizations`);
  }
}
