...
@Component({
          ...
          <span class="mat-form-field-label-wrapper">
            <label class="mat-form-field-label"
              ...
              <span class="mat-placeholder-required mat-form-field-required-marker"
                    aria-hidden="true"
                    *ngIf="!hideRequiredMarker && radioGroup && radioGroup.required && !radioGroup.disabled">&nbsp;*</span>
  ...
  host: {
    ...
    '[class.mat-form-field-disabled]': 'radioGroup && radioGroup.disabled',
    '[class.mat-accent]': 'color == "accent"',
    '[class.mat-warn]': 'color == "warn"',
...
export class RadioGroupFormFieldComponent extends MatFormField implements AfterContentInit, AfterContentChecked,
  AfterViewInit, CanColor {
  ...
  constructor(elementRef: ElementRef, private changeDetectorRef: ChangeDetectorRef,
              ...
              @Optional() @Inject(MAT_FORM_FIELD_DEFAULT_OPTIONS) formFieldDefaultOptions: MatFormFieldDefaultOptions,
              platform: Platform, zone: NgZone, @Optional() @Inject(ANIMATION_MODULE_TYPE) animationMode: string) {
    super(elementRef, changeDetectorRef, labelOptions, directionality, formFieldDefaultOptions, platform, zone,
      animationMode);
