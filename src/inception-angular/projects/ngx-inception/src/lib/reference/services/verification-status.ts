...
/**
 * The VerificationStatus class holds the information for a verification status.
 *
...
export class VerificationStatus {
  ...
  /**
   * The abbreviation for the verification status.
   */
  abbreviation: string;
  ...
  /**
   * Constructs a new VerificationStatus.
   *
   ...
   * @param abbreviation The abbreviation for the verification status.
