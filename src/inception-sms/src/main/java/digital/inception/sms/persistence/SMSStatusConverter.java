...
/**
 * The <b>SMSStatusConverter</b> class implements the custom JPA converter for the <b>SMSStatus</b>
 * enumeration.
 *
...
public class SMSStatusConverter implements AttributeConverter<SMSStatus, String> {

  /** Constructs a new <b>SMSStatusConverter</b>. */
  public SMSStatusConverter() {}
   ...
   */
  @Override
  public String convertToDatabaseColumn(SMSStatus attribute) {
   ...
   */
  @Override
  public SMSStatus convertToEntityAttribute(String dbData) {
