...
/**
 * The <b>SMSServiceException</b> exception is thrown to indicate an error condition when
...
public class SMSServiceException extends ServiceException {
  ...
  /**
   * Constructs a new <b>SMSServiceException</b> with the specified message.
   *
  ...
  /**
   * Constructs a new <b>SMSServiceException</b> with the specified message and cause.
   *
   * @param message The message saved for later retrieval by the <b>getMessage()</b> method.
