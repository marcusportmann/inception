...
/**
 * The <code>SMSServiceException</code> exception is thrown to indicate an error condition
 * when working with the SMS Service.
 * <p/>
...
@WebFault(name = "SMSServiceException",
