...
@Entity
@Table(schema = "party", name = "industry_classifications")
...
public class IndustryClassification implements Serializable {
  ...
  @Schema(description = "The description for the industry classification", required = true)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The name of the industry classification", required = true)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The sort index for the industry classification", required = true)
  @JsonProperty(required = true)
