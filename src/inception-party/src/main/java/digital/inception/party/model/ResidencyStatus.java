...
/**
 * The {@code ResidencyStatus} class holds the information for a residency status.
 *
 * @author Marcus Portmann
 */
@Schema(description = "A residency status")
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonPropertyOrder({"code", "localeId", "tenantId", "sortOrder", "name", "description"})
@XmlRootElement(name = "ResidencyStatus", namespace = "https://inception.digital/party")
@XmlType(
...
@Entity
@Table(name = "party_residency_statuses")
...
public class ResidencyStatus implements Serializable {
  ...
  @Schema(
      description = "The code for the residency status",
  ...
  @Schema(
      description = "The description for the residency status",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(
      description = "The Unicode locale identifier for the residency status",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(
      description = "The name of the residency status",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  /** The sort order for the residency status. */
  @Schema(
      description = "The sort order for the residency status",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The ID for the tenant the residency status is specific to")
  @JsonProperty
  @XmlElement(name = "TenantId")
  @Column(name = "tenant_id")
  private UUID tenantId;

  /** Constructs a new {@code ResidencyStatus}. */
  ...
  /**
   * Returns the sort order for the residency status.
   *
   * @return the sort order for the residency status
   */
  ...
  /**
   * Returns the ID for the tenant the residency status is specific to.
   *
   * @return the ID for the tenant the residency status is specific to
   */
