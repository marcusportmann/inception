      ...
      try {
            ...
            if (reservedAttributeTypeCode.equalsIgnoreCase(attribute.getType())) {
              hibernateConstraintValidatorContext
                  ...
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidOrganization.invalidReservedAttributeType.message}")
          ...
          if (!isReservedAttribute) {
            ...
            if (attributeTypeOptional.isPresent()) {
              ...
              if (attributeType.getUnitType() != null) {
                if ((attribute.getUnit() == null)
                  ...
                  hibernateConstraintValidatorContext
                      ...
                      .addMessageParameter("attributeType", attribute.getType())
                      .buildConstraintViolationWithTemplate(
                          "{digital.inception.party.constraint.ValidOrganization.invalidUnitForAttributeType.message}")
                      .addPropertyNode("attributes")
                ...
                case BOOLEAN:
                  if (attribute.getBooleanValue() == null) {
                    hibernateConstraintValidatorContext
                        .addMessageParameter("attributeType", attribute.getType())
                        .buildConstraintViolationWithTemplate(
                            "{digital.inception.party.constraint.ValidOrganization.invalidAttributeWithNullBooleanValue.message}")
                        .addPropertyNode("attributes")
                ...
                case DATE:
                  if (attribute.getDateValue() == null) {
                    hibernateConstraintValidatorContext
                        .addMessageParameter("attributeType", attribute.getType())
                        .buildConstraintViolationWithTemplate(
                            "{digital.inception.party.constraint.ValidOrganization.invalidAttributeWithNullDateValue.message}")
                        .addPropertyNode("attributes")
                ...
                case DECIMAL:
                  if (attribute.getDecimalValue() == null) {
                    hibernateConstraintValidatorContext
                        .addMessageParameter("attributeType", attribute.getType())
                        .buildConstraintViolationWithTemplate(
                            "{digital.inception.party.constraint.ValidOrganization.invalidAttributeWithNullDecimalValue.message}")
                        .addPropertyNode("attributes")
                ...
                case DOUBLE:
                  if (attribute.getDoubleValue() == null) {
                    hibernateConstraintValidatorContext
                        .addMessageParameter("attributeType", attribute.getType())
                        .buildConstraintViolationWithTemplate(
                            "{digital.inception.party.constraint.ValidOrganization.invalidAttributeWithNullDoubleValue.message}")
                        .addPropertyNode("attributes")
                ...
                case INTEGER:
                  if (attribute.getIntegerValue() == null) {
                    hibernateConstraintValidatorContext
                        .addMessageParameter("attributeType", attribute.getType())
                        .buildConstraintViolationWithTemplate(
                            "{digital.inception.party.constraint.ValidOrganization.invalidAttributeWithNullIntegerValue.message}")
                        .addPropertyNode("attributes")
                ...
                case STRING:
                  if (attribute.getStringValue() == null) {
                    hibernateConstraintValidatorContext
                        .addMessageParameter("attributeType", attribute.getType())
                        .buildConstraintViolationWithTemplate(
                            "{digital.inception.party.constraint.ValidOrganization.invalidAttributeWithNullStringValue.message}")
                        .addPropertyNode("attributes")
                    ...
                    if (StringUtils.hasText(attributeType.getPattern())) {
                      ...
                      if (!matcher.matches()) {
                        hibernateConstraintValidatorContext
                            ...
                            .buildConstraintViolationWithTemplate(
                                "{digital.inception.party.constraint.ValidOrganization.invalidAttributeWithStringValue.message}")
                            .addPropertyNode("attributes")
                            .addPropertyNode("stringValue")
                            .addConstraintViolation();
              ...
              hibernateConstraintValidatorContext
                  .addMessageParameter("attributeType", attribute.getType())
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidOrganization.invalidAttributeType.message}")
                  .addPropertyNode("attributes")
                  .addPropertyNode("type")
                  .inIterable()
                  .addConstraintViolation();
          ...
          if (StringUtils.hasText(contactMechanism.getType())) {
            ...
            if (contactMechanismTypeOptional.isPresent()) {
              ...
              if (StringUtils.hasText(contactMechanism.getRole())) {
                ...
                if (contactMechanismRoleOptional.isPresent()) {
                    ...
                    if (StringUtils.hasText(contactMechanismRole.getPattern())) {
                      ...
                      if (!matcher.matches()) {
                        hibernateConstraintValidatorContext
                            ...
                            .buildConstraintViolationWithTemplate(
                                "{digital.inception.party.constraint.ValidOrganization.invalidContactMechanism.message}")
                  ...
                  hibernateConstraintValidatorContext
                      .addMessageParameter("contactMechanismRole", contactMechanism.getRole())
                      .addMessageParameter("contactMechanismType", contactMechanism.getType())
                      .addMessageParameter("partyType", PartyType.ORGANIZATION.code())
                      .buildConstraintViolationWithTemplate(
                          "{digital.inception.party.constraint.ValidOrganization.invalidContactMechanismRoleForPartyType.message}")
                      .addPropertyNode("contactMechanisms")
              ...
              hibernateConstraintValidatorContext
                  .addMessageParameter("contactMechanismType", contactMechanism.getType())
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidOrganization.invalidContactMechanismType.message}")
                  .addPropertyNode("contactMechanisms")
                  .addPropertyNode("type")
                  .inIterable()
                  .addConstraintViolation();
        ...
        for (ExternalReference externalReference : organization.getExternalReferences()) {
          if (!getPartyReferenceService()
            ...
            hibernateConstraintValidatorContext
                ...
                .buildConstraintViolationWithTemplate(
                    "{digital.inception.party.constraint.ValidOrganization.invalidExternalReference.message}")
        ...
        if (StringUtils.hasText(organization.getIdentificationType())) {
          if (!getPartyReferenceService()
            ...
            hibernateConstraintValidatorContext
                ...
                .addMessageParameter("partyType", PartyType.ORGANIZATION.code())
                .buildConstraintViolationWithTemplate(
                    "{digital.inception.party.constraint.ValidOrganization.invalidIdentificationTypeForPartyType.message}")
            ...
            if (StringUtils.hasText(organization.getIdentificationNumber())) {
              if (!getPartyReferenceService()
                ...
                hibernateConstraintValidatorContext
                    ...
                    .addMessageParameter("identificationType", organization.getIdentificationType())
                    .buildConstraintViolationWithTemplate(
                        "{digital.inception.party.constraint.ValidOrganization.invalidIdentificationNumber.message}")
        ...
        if (StringUtils.hasText(organization.getIdentificationCountryOfIssue())
          ...
          hibernateConstraintValidatorContext
              ...
              .buildConstraintViolationWithTemplate(
                  "{digital.inception.party.constraint.ValidOrganization.invalidIdentificationCountryOfIssue.message}")
          ...
          if (StringUtils.hasText(identification.getNumber())) {
            if (!getPartyReferenceService()
              ...
              hibernateConstraintValidatorContext
                  ...
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidOrganization.invalidIdentification.message}")
                  .addPropertyNode("identifications")
                  .addConstraintViolation();
          ...
          if (StringUtils.hasText(industryAllocation.getSystem())
            ...
            if (!getPartyReferenceService()
              ...
              hibernateConstraintValidatorContext
                  ...
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidOrganization.invalidIndustryAllocation.message}")
        ...
        for (Lock lock : organization.getLocks()) {
          if (StringUtils.hasText(lock.getType())) {
            if (!getPartyReferenceService()
                .isValidLockType(
                    organization.getTenantId(), PartyType.ORGANIZATION.code(), lock.getType())) {
              hibernateConstraintValidatorContext
                  .addMessageParameter("lockType", lock.getType())
                  .addMessageParameter("partyType", PartyType.ORGANIZATION.code())
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidOrganization.invalidLockTypeForPartyType.message}")
          ...
          if (StringUtils.hasText(preference.getType())) {
            ...
            if (preferenceTypeOptional.isPresent()) {
              ...
              if (StringUtils.hasText(preferenceType.getPattern())) {
                ...
                if (!matcher.matches()) {
                  hibernateConstraintValidatorContext
                      ...
                      .buildConstraintViolationWithTemplate(
                          "{digital.inception.party.constraint.ValidOrganization.invalidPreferenceValue.message}")
              ...
              hibernateConstraintValidatorContext
                  ...
                  .addMessageParameter("partyType", PartyType.ORGANIZATION.code())
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidOrganization.invalidPreferenceTypeForPartyType.message}")
                  .addPropertyNode("preferences")
                  .addPropertyNode("type")
                  .inIterable()
                  .addConstraintViolation();
        ...
        for (Role role : organization.getRoles()) {
          if (StringUtils.hasText(role.getType())) {
            if (!getPartyReferenceService()
                .isValidRoleType(
                    organization.getTenantId(), PartyType.ORGANIZATION.code(), role.getType())) {
              hibernateConstraintValidatorContext
                  .addMessageParameter("roleType", role.getType())
                  .addMessageParameter("partyType", PartyType.ORGANIZATION.code())
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidOrganization.invalidRoleTypeForPartyType.message}")
          ...
          if (StringUtils.hasText(segmentAllocation.getSegment())) {
            if (!getPartyReferenceService()
              ...
              hibernateConstraintValidatorContext
                  ...
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidOrganization.invalidSegmentForSegmentAllocation.message}")
        ...
        for (Status status : organization.getStatuses()) {
          if (StringUtils.hasText(status.getType())) {
            if (!getPartyReferenceService()
                .isValidStatusType(
                    organization.getTenantId(), PartyType.ORGANIZATION.code(), status.getType())) {
              hibernateConstraintValidatorContext
                  .addMessageParameter("statusType", status.getType())
                  .addMessageParameter("partyType", PartyType.ORGANIZATION.code())
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidOrganization.invalidStatusTypeForPartyType.message}")
          ...
          if (StringUtils.hasText(taxNumber.getCountryOfIssue())) {
            if (!getReferenceService().isValidCountry(taxNumber.getCountryOfIssue())) {
              hibernateConstraintValidatorContext
                  ...
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidOrganization.invalidTaxNumberCountryOfIssue.message}")
          ...
          if (StringUtils.hasText(taxNumber.getType())) {
            if (!getPartyReferenceService()
              ...
              hibernateConstraintValidatorContext
                  ...
                  .addMessageParameter("partyType", PartyType.ORGANIZATION.code())
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidOrganization.invalidTaxNumberTypeForPartyType.message}")
                  .addPropertyNode("taxNumbers")
                  .addPropertyNode("type")
                  .inIterable()
                  .addConstraintViolation();
          ...
          if (StringUtils.hasText(taxNumber.getNumber())) {
            if (!getPartyReferenceService()
              ...
              hibernateConstraintValidatorContext
                  ...
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidOrganization.invalidTaxNumber.message}")
                  .addPropertyNode("taxNumbers")
                  .addConstraintViolation();
        ...
        switch (roleTypeAttributeTypeConstraint.getAttributeType()) {
          case "contact_mechanism":
            if (!organization.hasContactMechanismWithType(
              ...
              hibernateConstraintValidatorContext
                  ...
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidOrganization.contactMechanismTypeRequiredForRoleType.message}")
                  .addPropertyNode("contactMechanisms")
                  .addConstraintViolation();
          ...
          case "contact_mechanisms":
            if (!validateRequiredAttributeConstraint(
                ...
                "contactMechanisms",
                "{digital.inception.party.constraint.ValidOrganization.contactMechanismRequiredForRoleType.message}",
                hibernateConstraintValidatorContext)) {
              isValid = false;
            }
          ...
          case "countries_of_tax_residence":
            if (!validateRequiredAttributeConstraint(
                ...
                "{digital.inception.party.constraint.ValidOrganization.countryOfTaxResidenceRequiredForRoleType.message}",
                hibernateConstraintValidatorContext)) {
              isValid = false;
            }
          ...
          case "external_reference":
            if (!organization.hasExternalReferenceWithType(
              ...
              hibernateConstraintValidatorContext
                  ...
                  .addMessageParameter("roleType", roleType)
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidOrganization.externalReferenceTypeRequiredForRoleType.message}")
                  .addPropertyNode("externalReferences")
                  .addConstraintViolation();
          ...
          case "identification":
            if (!organization.hasIdentificationWithType(
              ...
              hibernateConstraintValidatorContext
                  ...
                  .addMessageParameter("roleType", roleType)
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidOrganization.identificationWithTypeRequiredForRoleType.message}")
                  .addPropertyNode("identifications")
                  .addConstraintViolation();
          ...
          case "identifications":
            if (!validateRequiredAttributeConstraint(
                ...
                "identifications",
                "{digital.inception.party.constraint.ValidOrganization.identificationRequiredForRoleType.message}",
                hibernateConstraintValidatorContext)) {
              isValid = false;
            }
          ...
          case "physical_addresses":
            if (!validateRequiredAttributeConstraint(
                ...
                "physicalAddresses",
                "{digital.inception.party.constraint.ValidOrganization.physicalAddressRequiredForRoleType.message}",
                hibernateConstraintValidatorContext)) {
              isValid = false;
            }
          ...
          case "physical_address":
            if (!organization.hasPhysicalAddressWithRole(
              ...
              hibernateConstraintValidatorContext
                  ...
                  .addMessageParameter("roleType", roleType)
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidOrganization.physicalAddressRoleRequiredForRoleType.message}")
          ...
          case "segment_allocations":
            if (!validateRequiredAttributeConstraint(
                ...
                "segmentAllocations",
                "{digital.inception.party.constraint.ValidOrganization.segmentAllocationRequiredForRoleType.message}",
                hibernateConstraintValidatorContext)) {
              isValid = false;
            }
          ...
          case "tax_numbers":
            if (!validateRequiredAttributeConstraint(
                ...
                "taxNumbers",
                "{digital.inception.party.constraint.ValidOrganization.taxNumberRequiredForRoleType.message}",
                hibernateConstraintValidatorContext)) {
              isValid = false;
            }
