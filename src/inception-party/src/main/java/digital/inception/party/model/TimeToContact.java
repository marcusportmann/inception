...
public class TimeToContact implements Serializable {
  ...
  @Schema(
      description = "The code for the time to contact",
  ...
  @Schema(
      description = "The description for the time to contact",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(
      description = "The Unicode locale identifier for the time to contact",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(
      description = "The name of the time to contact",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
