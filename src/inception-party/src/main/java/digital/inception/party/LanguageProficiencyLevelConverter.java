...
/**
 * The <b>LanguageProficiencyLevelConverter</b> class implements the custom JPA converter for the
 * <b>LanguageProficiencyLevel</b> enumeration.
 *
 * @author Marcus Portmann
 */
@Converter(autoApply = true)
public class LanguageProficiencyLevelConverter
    implements AttributeConverter<LanguageProficiencyLevel, String> {

  /** Constructs a new <b>LanguageProficiencyLevelConverter</b>. */
  public LanguageProficiencyLevelConverter() {}
  ...
  public LanguageProficiencyLevel convertToEntityAttribute(String dbData) {
    ...
    return LanguageProficiencyLevel.fromCode(dbData);
  }
}
