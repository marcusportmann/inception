...
@XmlRootElement(name = "SegmentationType", namespace = "http://inception.digital/party")
@XmlType(
...
@Entity
@Table(schema = "party", name = "segmentation_types")
...
public class SegmentationType implements Serializable {
  ...
  @Schema(description = "The code for the segmentation type", required = true)
  ...
  @Schema(description = "The description for the segmentation type", required = true)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The Unicode locale identifier for the segmentation type", required = true)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The name of the segmentation type", required = true)
  @JsonProperty(required = true)
  ...
  /** The comma-delimited codes for the party types the segmentation type is associated with. */
  @JsonIgnore
  @XmlTransient
  @NotNull
  @Size(min = 1, max = 310)
  ...
  @Schema(description = "The sort index for the segmentation type", required = true)
  @JsonProperty(required = true)
