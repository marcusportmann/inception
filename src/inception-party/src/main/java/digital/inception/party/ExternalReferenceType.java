 ...
 */
@Schema(description = "A type of external reference")
...
@IdClass(ExternalReferenceTypeId.class)
public class ExternalReferenceType implements Serializable {
  ...
  @Schema(
      description = "The Unicode locale identifier for the external reference type",
      required = true)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The name of the external reference type", required = true)
  @JsonProperty(required = true)
  ...
  /**
   * The comma-delimited codes for the party types the external reference type is associated with.
   */
  @JsonIgnore
  @XmlTransient
  @NotNull
  ...
  /**
   * The Universally Unique Identifier (UUID) for the tenant the external reference type is specific
   * to.
   */
  @Schema(
      description =
          "The Universally Unique Identifier (UUID) for the tenant the external reference type is specific to")
  @JsonProperty
  ...
  /**
   * Returns the Unicode locale identifier for the external reference type.
   *
   * @return the Unicode locale identifier for the external reference type
   */
  ...
  /**
   * Returns the codes for the party types the external reference type is associated with.
   *
   * @return the codes for the party types the external reference type is associated with
   */
  @Schema(
      description = "The codes for the party types the external reference type is associated with",
      required = true)
  @JsonProperty(required = true)
  ...
  /**
   * Returns the Universally Unique Identifier (UUID) for the tenant the external reference type is
   * specific to.
   *
   * @return the Universally Unique Identifier (UUID) for the tenant the external reference type is
   *     specific to
   */
  ...
  /**
   * Set the Universally Unique Identifier (UUID) for the tenant the external reference type is
   * specific to.
   *
