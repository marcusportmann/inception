...
/**
 * The {@code EmploymentType} class holds the information for an employment type.
 *
...
@XmlRootElement(name = "EmploymentType", namespace = "https://inception.digital/party")
@XmlType(
    name = "EmploymentType",
...
public class EmploymentType implements Serializable {
  ...
  /** The sort order for the employment type. */
  @Schema(
      description = "The sort order for the employment type",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  /**
   * Returns the sort order for the employment type.
   *
   * @return the sort order for the employment type
   */
