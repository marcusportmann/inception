  ...
  public static MeasurementUnit fromCode(String code) {
    switch (code) {
      case "metric_centimeter":
        return MeasurementUnit.METRIC_CENTIMETER;

      case "metric_meter":
        return MeasurementUnit.METRIC_METER;

      case "metric_kilogram":
        return MeasurementUnit.METRIC_KILOGRAM;

      case "imperial_inch":
        return MeasurementUnit.IMPERIAL_INCH;

      case "imperial_foot":
        return MeasurementUnit.IMPERIAL_FOOT;

      case "imperial_pound":
        return MeasurementUnit.IMPERIAL_POUND;

      case "customary_inch":
        return MeasurementUnit.CUSTOMARY_INCH;

      case "customary_foot":
        return MeasurementUnit.CUSTOMARY_FOOT;

      case "customary_pound":
        return MeasurementUnit.CUSTOMARY_POUND;
