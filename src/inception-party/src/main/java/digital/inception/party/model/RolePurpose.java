...
/**
 * The {@code RolePurpose} class holds the information for a purpose for a role.
 *
...
@XmlRootElement(name = "RolePurpose", namespace = "https://inception.digital/party")
@XmlType(
    name = "RolePurpose",
...
@Entity
@Table(name = "party_role_purposes")
...
public class RolePurpose implements Serializable {
  ...
  @Schema(
      description = "The code for the role purpose",
  ...
  @Schema(
      description = "The description for the role purpose",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(
      description = "The Unicode locale identifier for the role purpose",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The name of the role purpose", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  /** The sort order for the role purpose. */
  @Schema(
      description = "The sort order for the role purpose",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The ID for the tenant the role purpose is specific to")
  @JsonProperty
  ...
  /**
   * Returns the sort order for the role purpose.
   *
   * @return the sort order for the role purpose
   */
  ...
  /**
   * Returns the ID for the tenant the role purpose is specific to.
   *
   * @return the ID for the tenant the role purpose is specific to
   */
