 ...
 * an enterprise content management persistence. This approach allows an entity to be modified
...
@XmlRootElement(name = "Employment", namespace = "https://inception.digital/party")
@XmlType(
    name = "Employment",
...
public class Employment implements Serializable {
  ...
  @Schema(description = "The ID for the employment", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  /** The ID for the person the employment is associated with. */
  @Schema(hidden = true)
  @JsonIgnore
  @XmlTransient
  ...
  @Schema(
      description = "The ISO 8601 format start date for the employment",
