...
public class RolePurpose implements Serializable {
  ...
  /** The Universally Unique Identifier (UUID) for the tenant the role purpose is specific to. */
  @Schema(
      description =
          "The Universally Unique Identifier (UUID) for the tenant the role purpose is specific to")
  @JsonProperty
  ...
  /**
   * Returns the Universally Unique Identifier (UUID) for the tenant the role purpose is specific
   * to.
   *
   * @return the Universally Unique Identifier (UUID) for the tenant the role purpose is specific to
   */
  ...
  /**
   * Set the Universally Unique Identifier (UUID) for the tenant the role purpose is specific to.
   *
   * @param tenantId the Universally Unique Identifier (UUID) for the tenant the role purpose is
   *     specific to
   */
