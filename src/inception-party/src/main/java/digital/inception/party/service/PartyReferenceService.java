 ...
 */
public interface PartyReferenceService {
   ...
   *     retrieved
   */
  List<IdentificationType> getIdentificationTypes(String localeId)
      throws InvalidArgumentException, ServiceUnavailableException;

  /**
   * Retrieve the identification type reference data for a specific tenant and locale.
   *
   ...
   *     retrieved
   */
  List<IdentificationType> getIdentificationTypes(UUID tenantId, String localeId)
      throws InvalidArgumentException, ServiceUnavailableException;

  /**
   * Retrieve the identification type reference data for all locales.
   *
   * @return the identification type reference data
   * @throws ServiceUnavailableException if the identification type reference data could not be
   *     retrieved
   */
  List<IdentificationType> getIdentificationTypes() throws ServiceUnavailableException;
  ...
  /**
   * Check whether the identification is valid.
   *
   * @param tenantId the ID for the tenant
   * @param partyTypeCode the code for the party type
  ...
  /**
   * Check whether the code is a valid code for an identification type for the party type.
   *
   * @param tenantId the ID for the tenant
   * @param partyTypeCode the code for the party type
   * @param identificationTypeCode the code for the identification type
   ...
   */
  boolean isValidIdentificationType(
