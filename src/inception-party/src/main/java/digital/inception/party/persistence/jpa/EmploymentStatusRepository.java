...
import digital.inception.party.model.EmploymentStatusId;
import java.util.List;
import org.springframework.data.jpa.repository.JpaRepository;
import org.springframework.data.jpa.repository.Query;

/**
 * The {@code EmploymentStatusRepository} interface declares the persistence for the {@code
 * EmploymentStatus} domain type.
 *
...
public interface EmploymentStatusRepository
  ...
  /**
   * Retrieve all the employment statuses sorted by locale ID, sort index, and name.
   *
