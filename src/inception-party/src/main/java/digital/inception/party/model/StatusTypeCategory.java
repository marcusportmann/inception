...
public class StatusTypeCategory implements Serializable {
  ...
  /**
   * Sets the code for the status type category.
   *
  ...
  /**
   * Sets the description for the status type category.
   *
  ...
  /**
   * Sets the Unicode locale identifier for the status type category.
   *
  ...
  /**
   * Sets the name of the status type category.
   *
  ...
  /**
   * Sets the codes for the party types the status type category is associated with.
   *
  ...
  /**
   * Sets the sort order for the status type category.
   *
  ...
  /**
   * Sets the ID for the tenant the status type category is specific to.
   *
