...
public class Race implements Serializable {
  ...
  @Schema(description = "The code for the race", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  @Schema(description = "The description for the race", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(
      description = "The Unicode locale identifier for the race",
  ...
  @Schema(description = "The name of the race", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  /**
   * Returns the ID for the tenant the race is specific to.
   *
   * @return the ID for the tenant the race is specific to
   */
