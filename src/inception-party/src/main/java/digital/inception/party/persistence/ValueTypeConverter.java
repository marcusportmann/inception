...
/**
 * The <b>ValueTypeConverter</b> class implements the custom JPA converter for the <b>ValueType</b>
 * enumeration.
 *
...
public class ValueTypeConverter implements AttributeConverter<ValueType, String> {
  ...
  /** Constructs a new <b>ValueTypeConverter</b>. */
  ...
  public ValueType convertToEntityAttribute(String dbData) {
    ...
    return ValueType.fromCode(dbData);
  }
}
