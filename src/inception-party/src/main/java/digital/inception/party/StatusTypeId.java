...
/**
 * The <b>StatusTypeId</b> class implements the ID class for the <b>StatusType</b> class.
 *
...
public class StatusTypeId implements Serializable {
  ...
  /** Constructs a new <b>StatusTypeId</b>. */
  public StatusTypeId() {}
   ...
   */
  public StatusTypeId(String code, String localeId) {
    this.code = code;
  ...
  public boolean equals(Object object) {
    ...
    StatusTypeId other = (StatusTypeId) object;
