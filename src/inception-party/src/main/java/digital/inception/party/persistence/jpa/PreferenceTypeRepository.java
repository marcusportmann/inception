...
import digital.inception.party.model.PreferenceTypeId;
...
public interface PreferenceTypeRepository extends JpaRepository<PreferenceType, PreferenceTypeId> {
  ...
  /**
   * Find all the preference types sorted by locale ID, sort order, and name.
   *
   * @return all the preference types sorted by locale ID, sort order, and name.
   */
  @Query("select pt from PreferenceType pt order by pt.localeId, pt.sortOrder DESC, pt.name")
