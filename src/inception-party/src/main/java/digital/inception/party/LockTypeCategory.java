...
public class LockTypeCategory implements Serializable {
  ...
  /**
   * The Universally Unique Identifier (UUID) for the tenant the lock type category is specific to.
   */
  @Schema(
      description =
          "The Universally Unique Identifier (UUID) for the tenant the lock type category is specific to")
  ...
  /**
   * Returns the Universally Unique Identifier (UUID) for the tenant the lock type category is
   * specific to.
   *
   * @return the Universally Unique Identifier (UUID) for the tenant the lock type category is
   *     specific to
   */
  ...
  /**
   * Set the Universally Unique Identifier (UUID) for the tenant the lock type category is specific
   * to.
   *
