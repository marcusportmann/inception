...
@XmlRootElement(name = "Status", namespace = "https://inception.digital/party")
@XmlType(
    name = "Status",
...
public class Status implements Serializable {
  ...
  @Schema(description = "The ISO 8601 format date the status is effective from")
  @JsonProperty
  ...
  @Schema(description = "The ISO 8601 format date the status is effective to")
  @JsonProperty
  @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd")
