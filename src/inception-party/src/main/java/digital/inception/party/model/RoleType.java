...
@XmlRootElement(name = "RoleType", namespace = "https://inception.digital/party")
@XmlType(
    name = "RoleType",
...
public class RoleType implements Serializable {
  ...
  @Schema(
      description = "The description for the role type",
  ...
  @Schema(
      description = "The Unicode locale identifier for the role type",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The name of the role type", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  /** The sort order for the role type. */
  @Schema(
      description = "The sort order for the role type",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The ID for the tenant the role type is specific to")
  @JsonProperty
  ...
  /**
   * Returns the sort order for the role type.
   *
   * @return the sort order for the role type
   */
  ...
  /**
   * Returns the ID for the tenant the role type is specific to.
   *
   * @return the ID for the tenant the role type is specific to
   */
