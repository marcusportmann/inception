...
public class LinkType implements Serializable {
  ...
  @Schema(
      description = "The description for the link type",
  ...
  @Schema(
      description = "The Unicode locale identifier for the link type",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The name of the link type", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
