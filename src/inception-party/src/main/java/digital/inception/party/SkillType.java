...
@XmlRootElement(name = "SkillType", namespace = "http://inception.digital/party")
@XmlType(
    name = "SkillType",
...
@Entity
@Table(schema = "party", name = "skill_types")
...
public class SkillType implements Serializable {
  ...
  @Schema(description = "The description for the skill type", required = true)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The Unicode locale identifier for the skill type", required = true)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The name of the skill type", required = true)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The sort index for the skill type", required = true)
  @JsonProperty(required = true)
