...
/**
 * The {@code MandatePropertyTypeId} class implements the ID class for the {@code
 * MandatePropertyType} class.
 *
 * @author Marcus Portmann
 */
@SuppressWarnings({"UnusedDeclaration"})
public class MandatePropertyTypeId implements Serializable {
  ...
  public boolean equals(Object object) {
    ...
    MandatePropertyTypeId other = (MandatePropertyTypeId) object;
