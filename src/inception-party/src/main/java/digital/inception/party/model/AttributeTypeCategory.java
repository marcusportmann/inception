...
@XmlRootElement(name = "AttributeTypeCategory", namespace = "https://inception.digital/party")
@XmlType(
...
@IdClass(AttributeTypeCategoryId.class)
public class AttributeTypeCategory implements Serializable {
  ...
  @Schema(
      description = "The code for the attribute type category",
  ...
  /** The description for the attribute type category. */
  @Schema(
      description = "The description for the attribute type category",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(
      description = "The Unicode locale identifier for the attribute type category",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  /** The name of the attribute type category. */
  @Schema(
      description = "The name of the attribute type category",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  public boolean equals(Object object) {
    ...
    AttributeTypeCategory other = (AttributeTypeCategory) object;

    return Objects.equals(code, other.code) && Objects.equals(localeId, other.localeId);
  }

  /**
   * Returns the code for the attribute type category.
   *
   * @return the code for the attribute type category
   */
  ...
  /**
   * Returns the description for the attribute type category.
   *
   * @return the description for the attribute type category
   */
  ...
  /**
   * Returns the Unicode locale identifier for the attribute type category.
   *
   * @return the Unicode locale identifier for the attribute type category
   */
  ...
  /**
   * Returns the name of the attribute type category.
   *
   * @return the name of the attribute type category
   */
  ...
  /**
   * Returns the ID for the tenant the attribute type category is specific to.
   *
   * @return the ID for the tenant the attribute type category is specific to
   */
  ...
  /**
   * Sets the code for the attribute type category.
   *
  ...
  /**
   * Sets the description for the attribute type category.
   *
  ...
  /**
   * Sets the Unicode locale identifier for the attribute type category.
   *
  ...
  /**
   * Sets the name of the attribute type category.
   *
  ...
  /**
   * Sets the codes for the party types the attribute type category is associated with.
   *
  ...
  /**
   * Sets the sort order for the attribute type category.
   *
  ...
  /**
   * Sets the ID for the tenant the attribute type category is specific to.
   *
