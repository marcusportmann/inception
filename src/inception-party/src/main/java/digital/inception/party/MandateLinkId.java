...
/**
 * The <b>MandateLinkId</b> class implements the ID class for the <b>MandateLink</b> class.
 *
 * @author Marcus Portmann
 */
@SuppressWarnings({"UnusedDeclaration"})
public class MandateLinkId implements Serializable {
  ...
  /**
   * Constructs a new <b>MandateLinkId</b>.
   */
