...
/**
 * The {@code AttributeTypeCategoryId} class implements the ID class for the {@code
 * AttributeTypeCategory} class.
 *
...
public class AttributeTypeCategoryId implements Serializable {
  ...
  /** Creates a new {@code AttributeTypeCategoryId} instance. */
