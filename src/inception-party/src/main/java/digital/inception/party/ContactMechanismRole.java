...
@Entity
@Table(schema = "party", name = "contact_mechanism_roles")
...
public class ContactMechanismRole implements Serializable {
  ...
  @Schema(description = "The code for the contact mechanism role", required = true)
  ...
  @Size(min = 1, max = 30)
  @Id
  @Column(name = "contact_mechanism_type", length = 30, nullable = false)
  private String contactMechanismType;

  /** The description for the contact mechanism role. */
  @Schema(description = "The description for the contact mechanism role", required = true)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The name of the contact mechanism role", required = true)
  @JsonProperty(required = true)
