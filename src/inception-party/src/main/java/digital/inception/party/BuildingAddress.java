...
//  @Size(max = 20)
//  @Pattern(
//      message = "{digital.inception.party.BuildingAddress.Floor.Pattern.message}",
//      regexp = "^[\\pL\\pN-' ]*$")
...
//  @Size(min = 1, max = 50)
//  @Pattern(
//      message = "{digital.inception.party.BuildingAddress.Name.Pattern.message}",
//      regexp = "^[\\pL\\pN-' ]+$")
//  private String name;
//
...
//  @Size(max = 20)
//  @Pattern(
//      message = "{digital.inception.party.BuildingAddress.Room.Pattern.message}",
//      regexp = "^[\\pL\\pN-' ]*$")
//  private String room;
//
...
//   */
//  public BuildingAddress(String name, String floor, String room) {
//    this.name = name;
//    this.floor = floor;
//    this.room = room;
//  }
...
//   * @param floor the floor for the building address
//   */
//  public BuildingAddress(String name, String floor) {
//    this.name = name;
//    this.floor = floor;
//  }
//
...
//   * @param name the building name for the building address
//   */
//  public BuildingAddress(String name) {
//    this.name = name;
//  }
//
//  /**
