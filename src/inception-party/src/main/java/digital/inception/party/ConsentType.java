...
public class ConsentType implements Serializable {
  ...
  @Schema(description = "The description for the consent type", required = true)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The Unicode locale identifier for the consent type", required = true)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The name of the consent type", required = true)
  @JsonProperty(required = true)
  ...
  /** The Universally Unique Identifier (UUID) for the tenant the consent type is specific to. */
  @Schema(
      description =
          "The Universally Unique Identifier (UUID) for the tenant the consent type is specific to")
  @JsonProperty
  ...
  /**
   * Returns the Universally Unique Identifier (UUID) for the tenant the consent type is specific
   * to.
   *
   * @return the Universally Unique Identifier (UUID) for the tenant the consent type is specific to
   */
  ...
  /**
   * Set the Universally Unique Identifier (UUID) for the tenant the consent type is specific to.
   *
   * @param tenantId the Universally Unique Identifier (UUID) for the tenant the consent type is
   *     specific to
   */
