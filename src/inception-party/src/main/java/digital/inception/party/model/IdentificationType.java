...
/**
 * The <b>IdentificationType</b> class holds the information for an identification type.
 *
 * @author Marcus Portmann
 */
@Schema(description = "A type of identification")
...
@Entity
@Table(name = "party_identification_types")
@IdClass(IdentificationTypeId.class)
...
public class IdentificationType implements Serializable {
  ...
  /** The code for the country of issue for the identification type. */
  @Schema(
      description = "The code for the country of issue for the identification type",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  @XmlElement(name = "CountryOfIssue", required = true)
  @NotNull
  @Size(min = 1, max = 50)
  @Column(name = "country_of_issue", length = 50, nullable = false)
  private String countryOfIssue;

  /** The description for the identification type. */
  @Schema(
      description = "The description for the identification type",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(
      description = "The Unicode locale identifier for the identification type",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(
      description = "The name of the identification type",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  /** The comma-delimited codes for the party types the identification type is associated with. */
  @JsonIgnore
  @XmlTransient
  @NotNull
  @Size(min = 1, max = 310)
  ...
  /** The regular expression pattern used to validate a number for the identification type. */
  @Schema(
      description =
          "The regular expression pattern used to validate a number for the identification type")
  @JsonProperty
  ...
  /** Constructs a new <b>IdentificationType</b>. */
  ...
  /**
   * Returns the code for the country of issue for the identification type.
   *
   * @return the code for the country of issue for the identification type
   */
  ...
  /**
   * Returns the description for the identification type.
   *
   * @return the description for the identification type
   */
  ...
  /**
   * Returns the Unicode locale identifier for the identification type.
   *
   * @return the Unicode locale identifier for the identification type
   */
  ...
  /**
   * Returns the name of the identification type.
   *
   * @return the name of the identification type
   */
  ...
  /**
   * Returns the codes for the party types the identification type is associated with.
   *
   * @return the codes for the party types the identification type is associated with
   */
  @Schema(
      description = "The codes for the party types the identification type is associated with",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  /**
   * Returns the regular expression pattern used to validate a number for the identification type.
   *
   * @return the regular expression pattern used to validate a number for the identification type
   */
  ...
  /**
   * Returns the ID for the tenant the identification type is specific to.
   *
   * @return the ID for the tenant the identification type is specific to
   */
  ...
  /**
   * Returns whether the identification type is valid for the party type.
   *
   * @param partyTypeCode the code for the party type
   * @return <b>true</b> if the identification type is valid for the party type or <b>false</b>
   *     otherwise
   */
