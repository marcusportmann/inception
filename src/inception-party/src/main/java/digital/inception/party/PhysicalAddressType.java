...
public class PhysicalAddressType implements Serializable {
  ...
  /**
   * The Universally Unique Identifier (UUID) for the tenant the physical address type is specific
   * to.
   */
  @Schema(
      description =
  ...
  /**
   * Returns the Universally Unique Identifier (UUID) for the tenant the physical address type is
   * specific to.
   *
   * @return the Universally Unique Identifier (UUID) for the tenant the physical address type is
   *     specific to
   */
  ...
  /**
   * Set the Universally Unique Identifier (UUID) for the tenant the physical address type is
   * specific to.
   *
