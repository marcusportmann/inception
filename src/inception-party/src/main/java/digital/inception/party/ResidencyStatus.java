...
public class ResidencyStatus implements Serializable {
  ...
  /**
   * Returns the Universally Unique Identifier (UUID) for the tenant the residency status is
   * specific to.
   *
   * @return the Universally Unique Identifier (UUID) for the tenant the residency status is
   *     specific to
   */
  ...
  /**
   * Set the Universally Unique Identifier (UUID) for the tenant the residency status is specific
   * to.
   *
   * @param tenantId the Universally Unique Identifier (UUID) for the tenant the residency status is
   *     specific to
   */
