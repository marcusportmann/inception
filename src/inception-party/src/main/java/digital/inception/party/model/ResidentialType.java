...
/**
 * The {@code ResidentialType} class holds the information for a residential type.
 *
...
@XmlRootElement(name = "ResidentialType", namespace = "https://inception.digital/party")
@XmlType(
...
public class ResidentialType implements Serializable {
  ...
  /** The sort order for the residential type. */
  @Schema(
      description = "The sort order for the residential type",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  /**
   * Returns the sort order for the residential type.
   *
   * @return the sort order for the residential type
   */
