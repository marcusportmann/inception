...
@Entity
@Table(schema = "party", name = "residential_types")
...
public class ResidentialType implements Serializable {
  ...
  /**
   * Returns the Universally Unique Identifier (UUID) for the tenant the residential type is
   * specific to.
   *
   * @return the Universally Unique Identifier (UUID) for the tenant the residential type is
   *     specific to
   */
  ...
  /**
   * Set the Universally Unique Identifier (UUID) for the tenant the residential type is specific
   * to.
   *
   * @param tenantId the Universally Unique Identifier (UUID) for the tenant the residential type is
   *     specific to
   */
