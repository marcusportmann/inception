...
public class FieldOfStudy implements Serializable {
  ...
  @Schema(
      description = "The code for the field of study",
  ...
  @Schema(
      description = "The description for the field of study",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(
      description = "The Unicode locale identifier for the field of study",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  /**
   * Returns the ID for the tenant the field of study is specific to.
   *
   * @return the ID for the tenant the field of study is specific to
   */
