...
public class FieldOfStudy implements Serializable {
  ...
  /** The Universally Unique Identifier (UUID) for the tenant the field of study is specific to. */
  @Schema(
      description =
          "The Universally Unique Identifier (UUID) for the tenant the field of study is specific to")
  @JsonProperty
  ...
  /**
   * Returns the Universally Unique Identifier (UUID) for the tenant the field of study is specific
   * to.
   *
   * @return the Universally Unique Identifier (UUID) for the tenant the field of study is specific
   *     to
   */
  ...
  /**
   * Set the Universally Unique Identifier (UUID) for the tenant the field of study is specific to.
   *
   * @param tenantId the Universally Unique Identifier (UUID) for the tenant the field of study is
   *     specific to
   */
