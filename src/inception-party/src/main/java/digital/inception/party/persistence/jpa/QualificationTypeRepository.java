...
import digital.inception.party.model.QualificationTypeId;
...
public interface QualificationTypeRepository
  ...
  /**
   * Find all the qualification types sorted by locale ID, sort order, and name.
   *
   * @return all the qualification types sorted by locale ID, sort order, and name.
   */
  @Query("select qt from QualificationType qt order by qt.localeId, qt.sortOrder DESC, qt.name")
