...
/**
 * The <b>MeasurementUnitConverter</b> class implements the custom JPA converter for the
 * <b>MeasurementUnit</b> enumeration.
 *
...
public class MeasurementUnitConverter implements AttributeConverter<MeasurementUnit, String> {
  ...
  /** Constructs a new <b>MeasurementUnitConverter</b>. */
  ...
  public MeasurementUnit convertToEntityAttribute(String dbData) {
    ...
    return MeasurementUnit.fromCode(dbData);
  }
}
