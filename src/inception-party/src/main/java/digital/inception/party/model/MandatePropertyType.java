...
@Entity
@Table(name = "party_mandate_property_types")
...
public class MandatePropertyType implements Serializable {
  ...
  @Schema(
      description = "The description for the mandate property type",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(
      description = "The name of the mandate property type",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  /** The sort order for the mandate property type. */
  @Schema(
      description = "The sort order for the mandate property type",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(
      description = "The value type for the mandate property type",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  /**
   * Returns the sort order for the mandate property type.
   *
   * @return the sort order for the mandate property type
   */
