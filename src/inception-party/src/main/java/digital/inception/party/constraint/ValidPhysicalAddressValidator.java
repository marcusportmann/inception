...
//
/// **
// * The {@code ValidPhysicalAddressValidator} class implements the custom constraint validator for
...
//                .buildConstraintViolationWithTemplate(
//
// "{digital.inception.party.constraint.ValidPhysicalAddress.invalidPurpose.message}")
...
//                .buildConstraintViolationWithTemplate(
//
// "{digital.inception.party.constraint.ValidPhysicalAddress.invalidRole.message}")
