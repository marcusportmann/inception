...
@Entity
@Table(schema = "party", name = "employment_statuses")
...
public class EmploymentStatus implements Serializable {
  ...
  /**
   * The Universally Unique Identifier (UUID) for the tenant the employment status is specific to.
   */
  @Schema(
      description =
          "The Universally Unique Identifier (UUID) for the tenant the employment status is specific to")
  ...
  /**
   * Returns the Universally Unique Identifier (UUID) for the tenant the employment status is
   * specific to.
   *
   * @return the Universally Unique Identifier (UUID) for the tenant the employment status is
   *     specific to
   */
  ...
  /**
   * Set the Universally Unique Identifier (UUID) for the tenant the employment status is specific
   * to.
   *
