...
/**
 * The <b>PreferenceTypeCategory</b> class holds the information for a preference type category.
 *
...
public class PreferenceTypeCategory implements Serializable {
  ...
  /**
   * The comma-delimited codes for the party types the preference type category is associated with.
   */
  @JsonIgnore
  @XmlTransient
  @NotNull
  ...
  @Schema(
      description = "The sort index for the preference type category",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
   ...
   * @return <b>true</b> if the preference type category is valid for the party type or <b>false</b>
   *     otherwise
   */
