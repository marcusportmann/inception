...
/**
 * The {@code PreferenceTypeCategory} class holds the information for a preference type category.
 *
...
@XmlRootElement(name = "PreferenceTypeCategory", namespace = "https://inception.digital/party")
@XmlType(
...
@Entity
@Table(name = "party_preference_type_categories")
...
public class PreferenceTypeCategory implements Serializable {
  ...
  @Schema(
      description = "The code for the preference type category",
  ...
  @Schema(
      description = "The description for the preference type category",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(
      description = "The name of the preference type category",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(
      description = "The codes for the party types the preference type category is associated with",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  /** The sort order for the preference type category. */
  @Schema(
      description = "The sort order for the preference type category",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  /** Constructs a new {@code PreferenceTypeCategory}. */
  ...
  /**
   * Returns the codes for the party types the preference type category is associated with.
   *
   * @return the codes for the party types the preference type category is associated with
   */
  ...
  /**
   * Returns the sort order for the preference type category.
   *
   * @return the sort order for the preference type category
   */
  ...
  /**
   * Returns whether the preference type category is valid for the party type.
   *
   * @param partyTypeCode the code for the party type
   * @return {@code true} if the preference type category is valid for the party type or {@code
   *     false} otherwise
   */
