...
public class TimeToContact implements Serializable {
  ...
  /**
   * Returns the Universally Unique Identifier (UUID) for the tenant the time to contact is specific
   * to.
   *
   * @return the Universally Unique Identifier (UUID) for the tenant the time to contact is specific
   *     to
   */
  ...
  /**
   * Set the Universally Unique Identifier (UUID) for the tenant the time to contact is specific to.
   *
   * @param tenantId the Universally Unique Identifier (UUID) for the tenant the time to contact is
   *     specific to
   */
