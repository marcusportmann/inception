...
/**
 * The <b>RequiredMandatariesConverter</b> class implements the custom JPA converter for the
 * <b>RequiredMandataries</b> enumeration.
 *
 * @author Marcus Portmann
 */
@Converter(autoApply = true)
public class RequiredMandatariesConverter
    implements AttributeConverter<RequiredMandataries, String> {

  /** Constructs a new <b>RequiredMandatariesConverter</b>. */
  public RequiredMandatariesConverter() {}
   ...
   */
  @Override
  public String convertToDatabaseColumn(RequiredMandataries attribute) {
    if (attribute == null) {
      return null;
    }
   ...
   */
  @Override
  public RequiredMandataries convertToEntityAttribute(String dbData) {
    if (dbData == null) {
      return null;
    }
    return RequiredMandataries.fromCode(dbData);
  }
}
