...
/**
 * The {@code TaxNumberType} class holds the information for a tax number type.
 *
...
public class TaxNumberType implements Serializable {
   ...
   * @return {@code true} if the tax number type is valid for the party type or {@code false}
   *     otherwise
   */
