...
@XmlRootElement(name = "PhysicalAddressPurpose", namespace = "https://inception.digital/party")
@XmlType(
...
@Entity
@Table(name = "party_physical_address_purposes")
...
public class PhysicalAddressPurpose implements Serializable {
  ...
  @Schema(
      description = "The code for the physical address purpose",
  ...
  @Schema(
      description = "The description for the physical address purpose",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(
      description = "The name of the physical address purpose",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  /** The sort order for the physical address purpose. */
  @Schema(
      description = "The sort order for the physical address purpose",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  /**
   * Returns the sort order for the physical address purpose.
   *
   * @return the sort order for the physical address purpose
   */
