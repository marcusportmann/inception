...
/**
 * The <b>SegmentationTypeRepository</b> interface declares the repository for the <b>
 * SegmentationType</b> domain type.
 *
 * @author Marcus Portmann
 */
public interface SegmentationTypeRepository
    extends JpaRepository<SegmentationType, SegmentationTypeId> {

  /**
   * Retrieve all the segmentation types sorted by locale ID, sort index, and name.
   *
