...
@Entity
@Table(name = "party_contact_mechanism_types")
...
public class ContactMechanismType implements Serializable {
  ...
  @Schema(
      description = "The description for the contact mechanism type",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(
      description = "The name of the contact mechanism type",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(
      description = "The plural for the contact mechanism type",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  /**
   * Returns the ID for the tenant the contact mechanism type is specific to.
   *
   * @return the ID for the tenant the contact mechanism type is specific to
   */
