    ...
    if ((!StringUtils.hasText(attribute.getStringValue()))
      ...
      hibernateConstraintValidatorContext
          ...
          .buildConstraintViolationWithTemplate(
              "{digital.inception.party.constraint.ValidParty.invalidMaximumSizeForAttributeType.message}")
  ...
  protected boolean validateMaximumSizePreferenceConstraint(
    ...
    if ((!StringUtils.hasText(preference.getValue()))
      ...
      hibernateConstraintValidatorContext
          ...
          .buildConstraintViolationWithTemplate(
              "{digital.inception.party.constraint.ValidParty.invalidMaximumSizeForPreferenceType.message}")
  ...
  protected boolean validateMinimumSizeAttributeConstraint(
    ...
    if ((!StringUtils.hasText(attribute.getStringValue()))
      ...
      hibernateConstraintValidatorContext
          ...
          .addMessageParameter("attributeType", attribute.getType())
          .buildConstraintViolationWithTemplate(
              "{digital.inception.party.constraint.ValidParty.invalidMinimumSizeForAttributeType.message}")
          .addPropertyNode("attributes")
          .addPropertyNode("stringValue")
          .inIterable()
          .addConstraintViolation();
  ...
  protected boolean validateMinimumSizePreferenceConstraint(
    ...
    if ((!StringUtils.hasText(preference.getValue()))
      ...
      hibernateConstraintValidatorContext
          ...
          .addMessageParameter("preferenceType", preference.getType())
          .buildConstraintViolationWithTemplate(
              "{digital.inception.party.constraint.ValidParty.invalidMinimumSizeForPreferenceType.message}")
          .addPropertyNode("preferences")
          .addPropertyNode("value")
          .inIterable()
          .addConstraintViolation();
    ...
    if (StringUtils.hasText(attribute.getStringValue())) {
      if (!Pattern.matches(pattern, attribute.getStringValue())) {
        ...
        hibernateConstraintValidatorContext
            ...
            .addMessageParameter("attributeType", attribute.getType())
            .buildConstraintViolationWithTemplate(
                "{digital.inception.party.constraint.ValidParty.patternMatchFailedForAttributeType.message}")
            .addPropertyNode("attributes")
            .addPropertyNode("stringValue")
            .inIterable()
            .addConstraintViolation();
    ...
    if (StringUtils.hasText(preference.getValue())) {
      if (!Pattern.matches(pattern, preference.getValue())) {
        ...
        hibernateConstraintValidatorContext
            ...
            .addMessageParameter("preferenceType", preference.getType())
            .buildConstraintViolationWithTemplate(
                "{digital.inception.party.constraint.ValidParty.patternMatchFailedForPreferenceType.message}")
            .addPropertyNode("preferences")
            .addPropertyNode("value")
            .inIterable()
            .addConstraintViolation();
    ...
    try {
      if (!partyReferenceService.isValidPhysicalAddressType(tenantId, physicalAddress.getType())) {
        hibernateConstraintValidatorContext
            ...
            .buildConstraintViolationWithTemplate(
                "{digital.inception.party.constraint.ValidPhysicalAddress.invalidType.message}")
        ...
        switch (physicalAddress.getType()) {
          ...
          case PhysicalAddressType.BUILDING:
            if (!StringUtils.hasText(physicalAddress.getBuildingName())) {
              hibernateConstraintValidatorContext
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidPhysicalAddress.buildingNameRequired.message}")
                  .addPropertyNode("physicalAddresses")
            ...
            if (!StringUtils.hasText(physicalAddress.getCity())) {
              hibernateConstraintValidatorContext
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidPhysicalAddress.cityRequired.message}")
                  .addPropertyNode("physicalAddresses")
            ...
            if (!StringUtils.hasText(physicalAddress.getStreetName())) {
              hibernateConstraintValidatorContext
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidPhysicalAddress.streetNameRequired.message}")
                  .addPropertyNode("physicalAddresses")
          ...
          case PhysicalAddressType.COMPLEX:
            ...
            if (!StringUtils.hasText(physicalAddress.getComplexName())) {
              hibernateConstraintValidatorContext
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidPhysicalAddress.complexNameRequired.message}")
                  .addPropertyNode("physicalAddresses")
            ...
            if (!StringUtils.hasText(physicalAddress.getComplexUnitNumber())) {
              hibernateConstraintValidatorContext
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidPhysicalAddress.complexUnitNumberRequired.message}")
                  .addPropertyNode("physicalAddresses")
          ...
          case PhysicalAddressType.FARM:
            if (!StringUtils.hasText(physicalAddress.getFarmNumber())) {
              hibernateConstraintValidatorContext
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidPhysicalAddress.farmNumberRequired.message}")
                  .addPropertyNode("physicalAddresses")
          ...
          case PhysicalAddressType.INTERNATIONAL:
            if (!StringUtils.hasText(physicalAddress.getLine1())) {
              hibernateConstraintValidatorContext
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidPhysicalAddress.line1InternationalRequired.message}")
                  .addPropertyNode("physicalAddresses")
            ...
            if (StringUtils.hasText(physicalAddress.getStreetName())) {
              hibernateConstraintValidatorContext
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidPhysicalAddress.streetNameNotSupported.message}")
                  .addPropertyNode("physicalAddresses")
                  .addPropertyNode("streetName")
                  .addConstraintViolation();
            ...
            if (StringUtils.hasText(physicalAddress.getStreetNumber())) {
              hibernateConstraintValidatorContext
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidPhysicalAddress.streetNumberNotSupported.message}")
                  .addPropertyNode("physicalAddresses")
            ...
            if (StringUtils.hasText(physicalAddress.getSuburb())) {
              hibernateConstraintValidatorContext
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidPhysicalAddress.suburbNotSupported.message}")
                  .addPropertyNode("physicalAddresses")
          ...
          case PhysicalAddressType.POSTAL:
            if (!StringUtils.hasText(physicalAddress.getLine1())) {
              hibernateConstraintValidatorContext
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidPhysicalAddress.line1PostalRequired.message}")
                  .addPropertyNode("physicalAddresses")
                  .addPropertyNode("line1")
                  .addConstraintViolation();
          ...
          case PhysicalAddressType.SITE:
            ...
            if (!StringUtils.hasText(physicalAddress.getSiteBlock())) {
              hibernateConstraintValidatorContext
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidPhysicalAddress.siteBlockRequired.message}")
                  .addPropertyNode("physicalAddresses")
            ...
            if (!StringUtils.hasText(physicalAddress.getSiteNumber())) {
              hibernateConstraintValidatorContext
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidPhysicalAddress.siteNumberRequired.message}")
                  .addPropertyNode("physicalAddresses")
          ...
          case PhysicalAddressType.STREET:
            ...
            //
            // "{digital.inception.party.constraint.ValidPhysicalAddress.streetNumberRequired.message}")
            //            .addConstraintViolation();
            //
            //        isValid = false;
            //      }
          ...
          case PhysicalAddressType.UNSTRUCTURED:
            if (!StringUtils.hasText(physicalAddress.getLine1())) {
              hibernateConstraintValidatorContext
                  .buildConstraintViolationWithTemplate(
                      "{digital.inception.party.constraint.ValidPhysicalAddress.line1UnstructuredRequired.message}")
                  .addPropertyNode("physicalAddresses")
                  .addPropertyNode("line1")
                  .addConstraintViolation();
        ...
        if (!StringUtils.hasText(physicalAddress.getCountry())) {
          hibernateConstraintValidatorContext
              .buildConstraintViolationWithTemplate(
                  "{digital.inception.party.constraint.ValidPhysicalAddress.countryRequired.message}")
              .addPropertyNode("physicalAddresses")
        ...
        if (!StringUtils.hasText(physicalAddress.getPostalCode())) {
          hibernateConstraintValidatorContext
              .buildConstraintViolationWithTemplate(
                  "{digital.inception.party.constraint.ValidPhysicalAddress.postalCodeRequired.message}")
              .addPropertyNode("physicalAddresses")
        ...
        if (!physicalAddress.getType().equals(PhysicalAddressType.BUILDING)) {
          if (StringUtils.hasText(physicalAddress.getBuildingFloor())) {
            hibernateConstraintValidatorContext
                .buildConstraintViolationWithTemplate(
                    "{digital.inception.party.constraint.ValidPhysicalAddress.buildingFloorNotSupported.message}")
                .addPropertyNode("physicalAddresses")
          ...
          if (StringUtils.hasText(physicalAddress.getBuildingName())) {
            hibernateConstraintValidatorContext
                .buildConstraintViolationWithTemplate(
                    "{digital.inception.party.constraint.ValidPhysicalAddress.buildingNameNotSupported.message}")
                .addPropertyNode("physicalAddresses")
                .addPropertyNode("buildingName")
                .addConstraintViolation();
          ...
          if (StringUtils.hasText(physicalAddress.getBuildingRoom())) {
            hibernateConstraintValidatorContext
                .buildConstraintViolationWithTemplate(
                    "{digital.inception.party.constraint.ValidPhysicalAddress.buildingRoomNotSupported.message}")
                .addPropertyNode("physicalAddresses")
        ...
        if (!physicalAddress.getType().equals(PhysicalAddressType.COMPLEX)) {
          if (StringUtils.hasText(physicalAddress.getComplexName())) {
            hibernateConstraintValidatorContext
                .buildConstraintViolationWithTemplate(
                    "{digital.inception.party.constraint.ValidPhysicalAddress.complexNameNotSupported.message}")
                .addPropertyNode("physicalAddresses")
                .addPropertyNode("complexName")
                .addConstraintViolation();
          ...
          if (StringUtils.hasText(physicalAddress.getComplexUnitNumber())) {
            hibernateConstraintValidatorContext
                .buildConstraintViolationWithTemplate(
                    "{digital.inception.party.constraint.ValidPhysicalAddress.complexUnitNumberNotSupported.message}")
                .addPropertyNode("physicalAddresses")
        ...
        if (!physicalAddress.getType().equals(PhysicalAddressType.FARM)) {
          if (StringUtils.hasText(physicalAddress.getFarmDescription())) {
            hibernateConstraintValidatorContext
                .buildConstraintViolationWithTemplate(
                    "{digital.inception.party.constraint.ValidPhysicalAddress.farmDescriptionNotSupported.message}")
                .addPropertyNode("physicalAddresses")
          ...
          if (StringUtils.hasText(physicalAddress.getFarmName())) {
            hibernateConstraintValidatorContext
                .buildConstraintViolationWithTemplate(
                    "{digital.inception.party.constraint.ValidPhysicalAddress.farmNameNotSupported.message}")
                .addPropertyNode("physicalAddresses")
          ...
          if (StringUtils.hasText(physicalAddress.getFarmNumber())) {
            hibernateConstraintValidatorContext
                .buildConstraintViolationWithTemplate(
                    "{digital.inception.party.constraint.ValidPhysicalAddress.farmNumberNotSupported.message}")
                .addPropertyNode("physicalAddresses")
                .addPropertyNode("farmNumber")
                .addConstraintViolation();
        ...
        if (!physicalAddress.getType().equals(PhysicalAddressType.SITE)) {
          if (StringUtils.hasText(physicalAddress.getSiteBlock())) {
            hibernateConstraintValidatorContext
                .buildConstraintViolationWithTemplate(
                    "{digital.inception.party.constraint.ValidPhysicalAddress.siteBlockNotSupported.message}")
                .addPropertyNode("physicalAddresses")
                .addPropertyNode("siteBlock")
                .addConstraintViolation();
          ...
          if (StringUtils.hasText(physicalAddress.getSiteNumber())) {
            hibernateConstraintValidatorContext
                .buildConstraintViolationWithTemplate(
                    "{digital.inception.party.constraint.ValidPhysicalAddress.siteNumberNotSupported.message}")
                .addPropertyNode("physicalAddresses")
                .addPropertyNode("siteNumber")
                .addConstraintViolation();
        ...
        if ((!physicalAddress.getType().equals(PhysicalAddressType.INTERNATIONAL))
          ...
          if (StringUtils.hasText(physicalAddress.getLine1())) {
            hibernateConstraintValidatorContext
                .buildConstraintViolationWithTemplate(
                    "{digital.inception.party.constraint.ValidPhysicalAddress.line1NotSupported.message}")
                .addPropertyNode("physicalAddresses")
                .addPropertyNode("line1")
                .addConstraintViolation();
          ...
          if (StringUtils.hasText(physicalAddress.getLine2())) {
            hibernateConstraintValidatorContext
                .buildConstraintViolationWithTemplate(
                    "{digital.inception.party.constraint.ValidPhysicalAddress.line2NotSupported.message}")
                .addPropertyNode("physicalAddresses")
          ...
          if (StringUtils.hasText(physicalAddress.getLine3())) {
            hibernateConstraintValidatorContext
                .buildConstraintViolationWithTemplate(
                    "{digital.inception.party.constraint.ValidPhysicalAddress.line3NotSupported.message}")
                .addPropertyNode("physicalAddresses")
          ...
          if (StringUtils.hasText(physicalAddress.getLine4())) {
            hibernateConstraintValidatorContext
                .buildConstraintViolationWithTemplate(
                    "{digital.inception.party.constraint.ValidPhysicalAddress.line4NotSupported.message}")
                .addPropertyNode("physicalAddresses")
        ...
        if (StringUtils.hasText(physicalAddress.getCountry())
          ...
          hibernateConstraintValidatorContext
              ...
              .buildConstraintViolationWithTemplate(
                  "{digital.inception.party.constraint.ValidPhysicalAddress.invalidCountryCode.message}")
              .addPropertyNode("physicalAddresses")
              .addPropertyNode("country")
              .addConstraintViolation();
      ...
      if (StringUtils.hasText(physicalAddress.getRole())) {
        if (!getPartyReferenceService()
          ...
          hibernateConstraintValidatorContext
              ...
              .buildConstraintViolationWithTemplate(
                  "{digital.inception.party.constraint.ValidPhysicalAddress.invalidRoleForPartyType.message}")
              .addPropertyNode("physicalAddresses")
        ...
        case "contact_mechanism_type":
          ...
          if (!isValid) {
            hibernateConstraintValidatorContext
                ...
                .addMessageParameter("attributeType", attribute.getType())
                .buildConstraintViolationWithTemplate(
                    "{digital.inception.party.constraint.ValidParty.invalidContactMechanismTypeForAttributeType.message}")
                .addPropertyNode("attributes")
                .addPropertyNode("stringValue")
                .inIterable()
                .addConstraintViolation();
        ...
        case "country":
          ...
          if (!isValid) {
            hibernateConstraintValidatorContext
                ...
                .addMessageParameter("attributeType", attribute.getType())
                .buildConstraintViolationWithTemplate(
                    "{digital.inception.party.constraint.ValidParty.invalidCountryForAttributeType.message}")
                .addPropertyNode("attributes")
                .addPropertyNode("stringValue")
                .inIterable()
                .addConstraintViolation();
        ...
        case "language":
          ...
          if (!isValid) {
            hibernateConstraintValidatorContext
                ...
                .addMessageParameter("attributeType", attribute.getType())
                .buildConstraintViolationWithTemplate(
                    "{digital.inception.party.constraint.ValidParty.invalidLanguageForAttributeType.message}")
                .addPropertyNode("attributes")
                .addPropertyNode("stringValue")
                .inIterable()
                .addConstraintViolation();
        ...
        case "contact_mechanism_type":
          ...
          if (!isValid) {
            hibernateConstraintValidatorContext
                ...
                .addMessageParameter("preferenceType", preference.getType())
                .buildConstraintViolationWithTemplate(
                    "{digital.inception.party.constraint.ValidParty.invalidContactMechanismTypeForPreferenceType.message}")
                .addPropertyNode("preferences")
                .addPropertyNode("value")
                .inIterable()
                .addConstraintViolation();
        ...
        case "country":
          ...
          if (!isValid) {
            hibernateConstraintValidatorContext
                ...
                .addMessageParameter("preferenceType", preference.getType())
                .buildConstraintViolationWithTemplate(
                    "{digital.inception.party.constraint.ValidParty.invalidCountryForPreferenceType.message}")
                .addPropertyNode("preferences")
                .addPropertyNode("value")
                .inIterable()
                .addConstraintViolation();
        ...
        case "language":
          ...
          if (!isValid) {
            hibernateConstraintValidatorContext
                ...
                .addMessageParameter("preferenceType", preference.getType())
                .buildConstraintViolationWithTemplate(
                    "{digital.inception.party.constraint.ValidParty.invalidLanguageForPreferenceType.message}")
                .addPropertyNode("preferences")
                .addPropertyNode("value")
                .inIterable()
                .addConstraintViolation();
  ...
  protected boolean validateSizeAttributeConstraint(
    ...
    if ((!StringUtils.hasText(attribute.getStringValue()))
      ...
      hibernateConstraintValidatorContext
          ...
          .addMessageParameter("attributeType", attribute.getType())
          .buildConstraintViolationWithTemplate(
              "{digital.inception.party.constraint.ValidParty.invalidSizeForAttributeType.message}")
          .addPropertyNode("attributes")
          .addPropertyNode("stringValue")
          .inIterable()
          .addConstraintViolation();
  ...
  protected boolean validateSizePreferenceConstraint(
    ...
    if ((!StringUtils.hasText(preference.getValue())) || (preference.getValue().length() != size)) {
      hibernateConstraintValidatorContext
          ...
          .addMessageParameter("preferenceType", preference.getType())
          .buildConstraintViolationWithTemplate(
              "{digital.inception.party.constraint.ValidParty.invalidSizeForPreferenceType.message}")
          .addPropertyNode("preferences")
          .addPropertyNode("value")
          .inIterable()
          .addConstraintViolation();
