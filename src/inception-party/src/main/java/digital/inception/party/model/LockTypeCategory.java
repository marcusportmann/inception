...
public class LockTypeCategory implements Serializable {
  ...
  /** The sort order for the lock type category. */
  @Schema(
      description = "The sort order for the lock type category",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  /**
   * Returns the sort order for the lock type category.
   *
   * @return the sort order for the lock type category
   */
