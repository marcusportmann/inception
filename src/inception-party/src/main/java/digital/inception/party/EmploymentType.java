...
public class EmploymentType implements Serializable {
  ...
  /**
   * Returns the Universally Unique Identifier (UUID) for the tenant the employment type is specific
   * to.
   *
   * @return the Universally Unique Identifier (UUID) for the tenant the employment type is specific
   *     to
   */
  ...
  /**
   * Set the Universally Unique Identifier (UUID) for the tenant the employment type is specific to.
   *
   * @param tenantId the Universally Unique Identifier (UUID) for the tenant the employment type is
   *     specific to
   */
