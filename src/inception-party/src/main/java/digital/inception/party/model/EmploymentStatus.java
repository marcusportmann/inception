...
/**
 * The {@code EmploymentStatus} class holds the information for an employment status.
 *
...
public class EmploymentStatus implements Serializable {
  ...
  @Schema(
      description = "The code for the employment status",
  ...
  @Schema(
      description = "The description for the employment status",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(
      description = "The Unicode locale identifier for the employment status",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  @Schema(
      description = "The name of the employment status",
      requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty(required = true)
  ...
  /** Creates a new {@code EmploymentStatus} instance. */
  ...
  /**
   * Returns the ID for the tenant the employment status is specific to.
   *
   * @return the ID for the tenant the employment status is specific to
   */
