...
public class StatusTypeCategory implements Serializable {
  ...
  /** The comma-delimited codes for the party types the status type category is associated with. */
  @JsonIgnore
  @XmlTransient
  @NotNull
  @Size(min = 1, max = 310)
   ...
   * @return <b>true</b> if the status type category is valid for the party type or <b>false</b>
   *     otherwise
   */
