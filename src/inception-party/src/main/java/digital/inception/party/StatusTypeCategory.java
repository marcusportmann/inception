...
/**
 * The <b>StatusTypeCategory</b> class holds the information for a status type category.
 *
...
@Entity
@Table(schema = "party", name = "status_type_categories")
...
public class StatusTypeCategory implements Serializable {
  ...
  @Schema(description = "The code for the status type category", required = true)
  ...
  @Schema(description = "The description for the status type category", required = true)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The name of the status type category", required = true)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The sort index for the status type category", required = true)
  @JsonProperty(required = true)
  ...
  /**
   * The Universally Unique Identifier (UUID) for the tenant the status type category is specific
   * to.
   */
  @Schema(
      description =
          "The Universally Unique Identifier (UUID) for the tenant the status type category is specific to")
  @JsonProperty
  @XmlElement(name = "TenantId")
  @Column(name = "tenant_id")
  private UUID tenantId;

  /** Constructs a new <b>StatusTypeCategory</b>. */
  ...
  /**
   * Returns the Universally Unique Identifier (UUID) for the tenant the status type category is
   * specific to.
   *
   * @return the Universally Unique Identifier (UUID) for the tenant the status type category is
   *     specific to
   */
  ...
  /**
   * Set the Universally Unique Identifier (UUID) for the tenant the status type category is
   * specific to.
   *
