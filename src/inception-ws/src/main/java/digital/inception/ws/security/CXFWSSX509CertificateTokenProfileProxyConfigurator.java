...
/**
 * The {@code CXFWSSX509CertificateTokenProfileProxyConfigurator} class provides the capability to
 ...
 */
public final class CXFWSSX509CertificateTokenProfileProxyConfigurator {
  ...
  public static void configureProxy(
    ...
    if (invocationHandler instanceof ClientProxy clientProxy) {
      ...
      inProperties.put(WSHandlerConstants.ENABLE_SIGNATURE_CONFIRMATION, "true");
