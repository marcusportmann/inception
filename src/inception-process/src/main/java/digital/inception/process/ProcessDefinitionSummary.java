...
@XmlRootElement(name = "ProcessDefinitionSummary", namespace = "http://process.inception.digital")
@XmlType(name = "ProcessDefinitionSummary", namespace = "http://process.inception.digital",
    propOrder = { "id", "name" })
  ...
  implements Serializable
{
   ...
   */
  public ProcessDefinitionSummary(String id, String name)
  {
    this.id = id;
    this.name = name;
  }
