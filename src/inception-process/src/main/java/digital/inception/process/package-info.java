...
@javax.xml.bind.annotation.XmlSchema(namespace = "http://process.inception.digital",
    ...
    xmlns = { @javax.xml.bind.annotation.XmlNs(prefix = "core",
        ...
        @javax.xml.bind.annotation.XmlNs(prefix = "process",
            namespaceURI = "http://process.inception.digital") , })
