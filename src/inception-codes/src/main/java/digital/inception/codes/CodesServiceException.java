...
/**
 * The <b>CodesServiceException</b> exception is thrown to indicate an error condition when working
 * with the Codes Service.
 *
...
public class CodesServiceException extends ServiceException {
  ...
  /**
   * Constructs a new <b>CodesServiceException</b> with the specified message.
   *
  ...
  /**
   * Constructs a new <b>CodesServiceException</b> with the specified message and cause.
   *
   * @param message The message saved for later retrieval by the <b>getMessage()</b> method.
