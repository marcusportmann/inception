...
#liquibase --changeLogFile=../inception-application/src/main/resources/db/inception-application.changelog.xml --username=demo --password=demo --url=jdbc:postgresql://localhost:5432/demo --classpath=drivers/postgresql.jar --driver=org.postgresql.Driver update

#liquibase --changeLogFile=../inception-audit/src/main/resources/db/inception-audit.changelog.xml --username=demo --password=demo --url=jdbc:postgresql://localhost:5432/demo --classpath=drivers/postgresql.jar --driver=org.postgresql.Driver update
...
liquibase --changeLogFile=../inception-executor/src/main/resources/db/inception-executor.changelog.xml --username=demo --password=demo --url=jdbc:postgresql://localhost:5432/demo --classpath=drivers/postgresql.jar --driver=org.postgresql.Driver update
...
liquibase --changeLogFile=../inception-sms/src/main/resources/db/inception-sms.changelog.xml --username=demo --password=demo --url=jdbc:postgresql://localhost:5432/demo --classpath=drivers/postgresql.jar --driver=org.postgresql.Driver update
...
liquibase --changeLogFile=../inception-demo/src/main/resources/db/inception-party-demo-data.changelog.xml --username=demo --password=demo --url=jdbc:postgresql://localhost:5432/demo --classpath=drivers/postgresql.jar --driver=org.postgresql.Driver update
