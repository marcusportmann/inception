...
function update_liquibase_changelogs {
  ...
  liquibase --changeLogFile=../inception-executor/src/main/resources/db/inception-executor.changelog.xml --username=$db_username --password=$db_password --url=jdbc:oracle:thin:@$db_host:$db_port:$db_service --classpath=drivers/ojdbc11-23.2.0.0.jar --driver=oracle.jdbc.driver.OracleDriver update
