...
//     }
//
//     this.dataSource.load(this.userDirectoryId, filter, sortBy, sortDirection, pageIndex, pageSize);
//   }
//
//   newUser(): void {
//     // noinspection JSIgnoredPromiseFromCall
...
//     }));
//
//     if (this.sort && this.tableFilter && this.paginator && this.userDirectorySelect) {
...
//           })).subscribe());
//     } else {
//       console.log('One or more view children are invalid for the UsersComponent');
//     }
//
