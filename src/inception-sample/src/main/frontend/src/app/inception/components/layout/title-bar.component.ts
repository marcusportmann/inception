...
//       <div *ngIf="backNavigation | async as backNavigation" class="back" (click)="navigateBack(backNavigation)"><span class="fa fa-chevron-left"></span> {{backNavigation.title}}</div>
...
//
//   @Input() backNavigation: Observable<BackNavigation>;
//
//   /**
...
//
//     if (this.fixed) {
//       document.querySelector('body').classList.add('title-bar-fixed');
//     }
//   }
// }
...
export class TitleBarComponent implements OnInit {
   ...
   * The back navigation.
   */
  get backNavigation(): Observable<BackNavigation> {
