...
export class CodesService {
  ...
  createCode(code: Code): Observable<boolean> {
    return this.httpClient.post<boolean>(environment.codesServiceUrlPrefix + '/code-categories/' +
      encodeURIComponent(code.codeCategoryId) + '/codes', code, {observe: 'response'})
  ...
  deleteCode(codeCategoryId: string, codeId: string): Observable<boolean> {
    return this.httpClient.delete<boolean>(
      ...
      '/codes/' + encodeURIComponent(codeId), {observe: 'response'})
      .pipe(map((httpResponse: HttpResponse<boolean>) => {
        return httpResponse.status === 204;
      }), catchError((httpErrorResponse: HttpErrorResponse) => {
        if (ApiError.isApiError(httpErrorResponse)) {
  ...
  getCode(codeCategoryId: string, codeId: string): Observable<Code> {
    return this.httpClient.get<Code>(
      environment.codesServiceUrlPrefix + '/code-categories/' + encodeURIComponent(codeCategoryId) +
      '/codes/' + encodeURIComponent(codeId), {reportProgress: true}).pipe(map((code: Code) => {
      return code;
    }), catchError((httpErrorResponse: HttpErrorResponse) => {
      if (ApiError.isApiError(httpErrorResponse)) {
        const apiError: ApiError = new ApiError(httpErrorResponse);
  ...
  getCodes(codeCategoryId: string): Observable<Code[]> {
    return this.httpClient.get<Code[]>(
      environment.codesServiceUrlPrefix + '/code-categories/' + encodeURIComponent(codeCategoryId) +
      '/codes', {reportProgress: true}).pipe(map((codes: Code[]) => {
      return codes;
    }), catchError((httpErrorResponse: HttpErrorResponse) => {
      if (ApiError.isApiError(httpErrorResponse)) {
        const apiError: ApiError = new ApiError(httpErrorResponse);
  ...
  updateCode(code: Code): Observable<boolean> {
    return this.httpClient.put<boolean>(environment.codesServiceUrlPrefix + '/code-categories/' +
      encodeURIComponent(code.codeCategoryId) + '/codes/' + encodeURIComponent(code.id), code,
      {observe: 'response'}).pipe(map((httpResponse: HttpResponse<boolean>) => {
      return httpResponse.status === 204;
    }), catchError((httpErrorResponse: HttpErrorResponse) => {
      if (ApiError.isApiError(httpErrorResponse)) {
  ...
  updateCodeCategory(codeCategory: CodeCategory): Observable<boolean> {
    return this.httpClient.put<boolean>(
      environment.codesServiceUrlPrefix + '/code-categories/' + encodeURIComponent(codeCategory.id),
      codeCategory, {observe: 'response'}).pipe(map((httpResponse: HttpResponse<boolean>) => {
      return httpResponse.status === 204;
    }), catchError((httpErrorResponse: HttpErrorResponse) => {
      if (ApiError.isApiError(httpErrorResponse)) {
