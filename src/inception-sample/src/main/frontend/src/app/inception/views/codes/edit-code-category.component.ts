...
// })
// export class EditCodeCategoryComponent extends AdminContainerView implements AfterViewInit, OnInit {
//
...
//
//     this.codesService.getCodeCategory(this.idFormControl.value)
...
//
//     if (!!codeCategoryId) {
//       this.idFormControl.setValue(codeCategoryId);
//     }
//   }
//
//   onCancel(): void {
