...
export OTEL_TRACING_API_RULE_ENABLED=${OTEL_TRACING_API_RULE_ENABLED:-true}
export OTEL_TRACING_INTERNAL_SPAN_RULE_PACKAGES=${OTEL_TRACING_INTERNAL_SPAN_RULE_PACKAGES:-demo}
export OTEL_TRACING_INCEPTION_FRAMEWORK_RULE_ENABLED=${OTEL_TRACING_INCEPTION_FRAMEWORK_RULE_ENABLED:-false}
export OTEL_TRACING_RULE_LOGGING_ENABLED=${OTEL_TRACING_RULE_LOGGING_ENABLED:-false}
