 ...
 * <b>String</b> type into a <b>TaskSortBy</b> type.
 *
...
public class StringToTaskSortByConverter implements Converter<String, TaskSortBy> {
  ...
  /** Constructs a new <b>StringToTaskSortByConverter</b>. */
  public StringToTaskSortByConverter() {}

  @Override
  public TaskSortBy convert(@NonNull String source) {
    return TaskSortBy.fromCode(source);
  }
}
