 ...
 * <b>String</b> type into a <b>TaskStatus</b> type.
 *
...
public class StringToTaskStatusConverter implements Converter<String, TaskStatus> {
  ...
  /** Constructs a new <b>StringToTaskStatusConverter</b>. */
  public StringToTaskStatusConverter() {}

  @Override
  public TaskStatus convert(@NonNull String source) {
    return TaskStatus.fromCode(source);
  }
}
