...
/**
 * The <b>TaskEventTypeListConverter</b> class implements the custom JPA converter for a list of
 * <b>TaskEventType</b> instances.
 *
 * @author Marcus Portmann
 */
@Converter(autoApply = true)
public class TaskEventTypeListConverter implements AttributeConverter<List<TaskEventType>, String> {

  /** Constructs a new <b>TaskEventTypeListConverter</b>. */
  public TaskEventTypeListConverter() {}
