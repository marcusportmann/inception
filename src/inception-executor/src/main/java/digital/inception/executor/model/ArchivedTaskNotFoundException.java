 ...
 */
@Problem(
    type = "https://inception.digital/problems/executor/archived-task-not-found",
    title = "The archived task could not be found.",
    status = 404)
@WebFault(
    name = "ArchivedTaskNotFoundException",
    targetNamespace = "https://inception.digital/executor",
    faultBean = "digital.inception.core.service.ServiceError")
@XmlAccessorType(XmlAccessType.PROPERTY)
public class ArchivedTaskNotFoundException extends ServiceException {
   ...
   */
  public ArchivedTaskNotFoundException(UUID archivedTaskId) {
    super("The archived task (" + archivedTaskId + ") could not be found");
  }
}
