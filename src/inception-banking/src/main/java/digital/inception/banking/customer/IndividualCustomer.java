...
//  @Schema(
//      description =
//          "The optional boolean flag indicating whether the individual customer is an emancipated
// minor")
//  @JsonProperty
...
//
//  /**
//   * Retrieve the contact mechanism with the specified type and purpose for the individual
// customer.
//   *
...
//
//  /**
//   * Returns the optional boolean flag indicating whether the individual customer is an
// emancipated
//   * minor.
//   *
//   * @return the optional boolean flag indicating whether the individual customer is an
// emancipated
//   *     minor
//   */
...
//   *
//   * <p>In Western culture, this is constructed from a combination of the given name (also known
// as
...
//   */
//  @Schema(description = "The code for the occupation for the individual customer", required =
// true)
//  @JsonProperty(required = true)
//  @Override
...
//   * minor.
//   *
//   * @param emancipatedMinor the optional boolean flag indicating whether the individual customer
// is
