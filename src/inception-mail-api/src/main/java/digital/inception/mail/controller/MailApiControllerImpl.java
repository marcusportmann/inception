...
public class MailApiControllerImpl extends SecureApiController implements MailApiController {
   ...
   */
  public MailApiControllerImpl(ApplicationContext applicationContext, MailService mailService) {
