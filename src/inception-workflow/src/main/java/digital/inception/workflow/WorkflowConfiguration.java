  ...
  public LocalContainerEntityManagerFactoryBean workflowEntityManagerFactory(
    ...
    public ProcessEngine processEngine(FormService formService) {
      try {
        ...
        processEngineConfiguration.setAppResourceConverter(new AppResourceConverterImpl(objectMapper));
...
//        processEngineConfiguration.setFormService(new FormServiceImpl());
        ...
        // TODO: CONVERT CAMUNDA processEngineConfiguration.setHistory(ProcessEngineConfiguration.HISTORY_DEFAULT);
  ...
  private DataSource unwrapDataSource(DataSource dataSource) {
    ...
    if (dataSource.getClass().getName().equals("io.agroal.pool.DataSource")) {
      ...
      if (connectionPool != null) {
        Field connectionFactoryField = connectionPool.getClass().getDeclaredField("connectionFactory");
        ...
        throw new RuntimeException("Failed to unwrap the data source (" + dataSource.getClass().getName() + ")", e);
      }
  }
