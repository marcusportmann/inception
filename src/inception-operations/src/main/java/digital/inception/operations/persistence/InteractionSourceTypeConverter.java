...
/**
 * The <b>InteractionSourceTypeConverter</b> class implements the custom JPA converter for the
 * <b>InteractionSourceType</b> enumeration.
 *
 * @author Marcus Portmann
 */
@Converter(autoApply = true)
public class InteractionSourceTypeConverter
    implements AttributeConverter<InteractionSourceType, String> {

  /** Constructs a new <b>InteractionSourceTypeConverter</b>. */
  public InteractionSourceTypeConverter() {}
   ...
   */
  @Override
  public String convertToDatabaseColumn(InteractionSourceType attribute) {
    if (attribute == null) {
      return null;
    }
   ...
   */
  @Override
  public InteractionSourceType convertToEntityAttribute(String dbData) {
    if (dbData == null) {
      return null;
    }
    return InteractionSourceType.fromCode(dbData);
  }
}
