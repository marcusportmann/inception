...
@Problem(
    ...
    status = 409)
@WebFault(
    name = "DuplicateDocumentDefinitionException",
    targetNamespace = "https://inception.digital/operations",
    faultBean = "digital.inception.core.service.ServiceError")
@XmlAccessorType(XmlAccessType.PROPERTY)
public class DuplicateDocumentDefinitionException extends ServiceException {
   ...
   */
  public DuplicateDocumentDefinitionException(String documentDefinitionId) {
    super("The document definition (" + documentDefinitionId + ") already exists");
  }
}
