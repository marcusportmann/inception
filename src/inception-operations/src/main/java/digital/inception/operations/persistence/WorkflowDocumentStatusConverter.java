...
/**
 * The <b>WorkflowDocumentStatusConverter</b> class implements the custom JPA converter for the
 * <b>WorkflowDocumentStatus</b> enumeration.
 *
...
public class WorkflowDocumentStatusConverter implements AttributeConverter<WorkflowDocumentStatus, String> {
   ...
   */
  @Override
  public String convertToDatabaseColumn(WorkflowDocumentStatus attribute) {
    if (attribute == null) {
      return null;
    }
   ...
   */
  @Override
  public WorkflowDocumentStatus convertToEntityAttribute(String dbData) {
    if (dbData == null) {
      return null;
    }
    return WorkflowDocumentStatus.fromCode(dbData);
  }
}
