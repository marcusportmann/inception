...
/**
 * The <b>DocumentNotFoundException</b> exception is thrown to indicate an error condition as a
 * result of a document that could not be found.
 *
 ...
 */
@Problem(
    type = "https://inception.digital/problems/operations/document-not-found",
...
public class DocumentNotFoundException extends ServiceException {
  ...
  /**
   * w Constructs a new <b>DocumentNotFoundException</b>.
   *
