...
/**
 * The {@code ObjectNotFoundException} exception is thrown to indicate an error condition as a
 * result of a object that could not be found.
 *
 ...
 */
@Problem(
    type = "https://inception.digital/problems/operations/object-not-found",
...
public class ObjectNotFoundException extends ServiceException {
  ...
  /**
   * Constructs a new {@code ObjectNotFoundException}.
   *
   * @param objectType the object type for the object
   * @param objectId the ID for the object
   */
  public ObjectNotFoundException(ObjectType objectType, UUID objectId) {
    super("The object (" + objectId + ") of type (" + objectType + ") could not be found");
  }
}
