...
public class ExternalReferenceId implements Serializable {
   ...
   */
  public ExternalReferenceId(UUID objectId, String type) {
  ...
  public boolean equals(Object object) {
    ...
    return Objects.equals(objectId, other.objectId)
        && StringUtil.equalsIgnoreCase(type, other.type);
  }
  ...
  @Override
  public int hashCode() {
    return ((objectId == null) ? 0 : objectId.hashCode()) + ((type == null) ? 0 : type.hashCode());
  }
}
