...
public class RequiredDocumentAttributeAttributeConverter
    extends AbstractCodeEnumAttributeConverter<RequiredDocumentAttribute> {

  /** Constructs a new {@code RequiredDocumentAttributeAttributeConverter}. */
  public RequiredDocumentAttributeAttributeConverter() {
    super(RequiredDocumentAttribute.class);
  }
}
