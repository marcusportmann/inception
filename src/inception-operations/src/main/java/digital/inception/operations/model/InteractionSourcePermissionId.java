...
/**
 * The {@code InteractionSourcePermissionId} class implements the ID class for The {@code
 * InteractionSourcePermission} class.
 *
 * @author Marcus Portmann
 */
@SuppressWarnings({"UnusedDeclaration"})
public class InteractionSourcePermissionId implements Serializable {
  ...
  public boolean equals(Object object) {
    ...
    InteractionSourcePermissionId other = (InteractionSourcePermissionId) object;
