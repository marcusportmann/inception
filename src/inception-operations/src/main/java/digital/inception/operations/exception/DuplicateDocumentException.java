 ...
 */
@Problem(
    type = "https://inception.digital/problems/operations/duplicate-document",
    title = "A document with the specified ID already exists.",
    status = 409)
@WebFault(
    name = "DuplicateDocumentException",
    targetNamespace = "https://inception.digital/operations",
    faultBean = "digital.inception.core.service.ServiceError")
@XmlAccessorType(XmlAccessType.PROPERTY)
public class DuplicateDocumentException extends ServiceException {
  ...
  public DuplicateDocumentException(UUID documentId) {
    super("The document (" + documentId + ") already exists");
  }
}
