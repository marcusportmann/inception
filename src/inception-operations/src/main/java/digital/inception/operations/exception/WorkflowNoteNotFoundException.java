...
/**
 * The {@code WorkflowNoteNotFoundException} exception is thrown to indicate an error condition as a
 * result of a workflow note that could not be found.
 *
 ...
 */
@Problem(
    type = "https://inception.digital/problems/operations/workflow-note-not-found",
    title = "The workflow note could not be found.",
    status = 404)
@WebFault(
    name = "WorkflowNoteNotFoundException",
    targetNamespace = "https://inception.digital/operations",
    faultBean = "digital.inception.core.service.ServiceError")
@XmlAccessorType(XmlAccessType.PROPERTY)
public class WorkflowNoteNotFoundException extends ServiceException {
