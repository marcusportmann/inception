...
/**
 * The {@code UnsuspendWorkflowRequest} class represents a request to unsuspend a workflow.
 *
 * @author Marcus Portmann
 */
@Schema(description = "A request to unsuspend a workflow")
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonPropertyOrder({"workflowId"})
@XmlRootElement(
    name = "UnsuspendWorkflowRequest",
...
public class UnsuspendWorkflowRequest implements Serializable {
  ...
  /** Constructs a new {@code UnsuspendWorkflowRequest}. */
  public UnsuspendWorkflowRequest() {}
