...
/**
 * The <b>WorkflowStatusConverter</b> class implements the custom JPA converter for the
 * <b>WorkflowStatus</b> enumeration.
 *
...
public class WorkflowStatusConverter implements AttributeConverter<WorkflowStatus, String> {
  ...
  /** Constructs a new <b>WorkflowStatusConverter</b>. */
  public WorkflowStatusConverter() {}
  ...
  public WorkflowStatus convertToEntityAttribute(String dbData) {
    ...
    return WorkflowStatus.fromCode(dbData);
  }
}
