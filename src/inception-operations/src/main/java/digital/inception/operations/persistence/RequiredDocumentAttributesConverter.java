...
/**
 * The <b>RequiredDocumentAttributesConverter</b> class implements the custom JPA converter used to
 * store a list of <b>RequiredDocumentAttribute</b>s as a String.
 *
 * @author Marcus Portmann
 */
@Converter(autoApply = true)
public class RequiredDocumentAttributesConverter
    implements AttributeConverter<List<RequiredDocumentAttribute>, String> {

  /** Constructs a new <b>RequiredDocumentAttributesConverter</b>. */
  public RequiredDocumentAttributesConverter() {}
