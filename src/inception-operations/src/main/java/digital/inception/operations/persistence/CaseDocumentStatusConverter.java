...
/**
 * The <b>CaseDocumentStatusConverter</b> class implements the custom JPA converter for the
 * <b>CaseDocumentStatus</b> enumeration.
 *
 * @author Marcus Portmann
 */
@Converter(autoApply = true)
public class CaseDocumentStatusConverter implements AttributeConverter<CaseDocumentStatus, String> {

  /** Constructs a new <b>CaseDocumentStatusConverter</b>. */
  public CaseDocumentStatusConverter() {}
   ...
   */
  @Override
  public String convertToDatabaseColumn(CaseDocumentStatus attribute) {
    if (attribute == null) {
      return null;
    }
   ...
   */
  @Override
  public CaseDocumentStatus convertToEntityAttribute(String dbData) {
    if (dbData == null) {
      return null;
    }
    return CaseDocumentStatus.fromCode(dbData);
  }
}
