...
/**
 * The {@code InitiateWorkflowStepRequest} class represents a request to initiate a workflow step.
 *
 * @author Marcus Portmann
 */
@Schema(description = "A request to initiate a workflow step")
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonPropertyOrder({"workflowId", "step"})
@XmlRootElement(
    name = "InitiateWorkflowStepRequest",
...
public class InitiateWorkflowStepRequest implements Serializable {
  ...
  /** Constructs a new {@code InitiateWorkflowStepRequest}. */
  public InitiateWorkflowStepRequest() {}
   ...
   */
  public InitiateWorkflowStepRequest(UUID workflowId, String step) {
