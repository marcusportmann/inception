...
/**
 * The {@code UpdateInteractionNoteRequest} class represents a request to update a interaction note.
 *
 * @author Marcus Portmann
 */
@Schema(description = "A request to update a interaction note")
