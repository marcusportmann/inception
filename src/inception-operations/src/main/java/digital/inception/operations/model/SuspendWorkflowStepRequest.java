...
/**
 * The {@code SuspendWorkflowStepRequest} class represents a request to suspend a workflow step.
 *
 * @author Marcus Portmann
 */
@Schema(description = "A request to suspend a workflow step")
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonPropertyOrder({"workflowId", "step"})
@XmlRootElement(
    name = "SuspendWorkflowStepRequest",
...
public class SuspendWorkflowStepRequest implements Serializable {
  ...
  /** Constructs a new {@code SuspendWorkflowStepRequest}. */
  public SuspendWorkflowStepRequest() {}
   ...
   */
  public SuspendWorkflowStepRequest(UUID workflowId, String step) {
