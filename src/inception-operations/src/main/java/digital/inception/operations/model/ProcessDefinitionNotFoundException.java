...
/**
 * The <b>ProcessDefinitionNotFoundException</b> exception is thrown to indicate an error condition as
 * a result of a process definition that could not be found.
 *
 ...
 */
@Problem(
    type = "https://nova.discovery.co.za/problems/operations/process-definition-not-found",
...
public class ProcessDefinitionNotFoundException extends ServiceException {
  ...
  public ProcessDefinitionNotFoundException(String processDefinitionId) {
    super("The process definition (" + processDefinitionId + ") could not be found");
  }
}
