...
/**
 * The <b>ProcessStatusConverter</b> class implements the custom JPA converter for the
 * <b>ProcessStatus</b> enumeration.
 *
...
public class ProcessStatusConverter implements AttributeConverter<ProcessStatus, String> {
  ...
  /** Constructs a new <b>ProcessStatusConverter</b>. */
  ...
  public ProcessStatus convertToEntityAttribute(String dbData) {
    ...
    return ProcessStatus.fromCode(dbData);
  }
}
