...
/**
 * The <b>InteractionTypeConverter</b> class implements the custom JPA converter for the
 * <b>InteractionType</b> enumeration.
 *
...
public class InteractionTypeConverter implements AttributeConverter<InteractionType, String> {
  ...
  /** Constructs a new <b>InteractionTypeConverter</b>. */
  ...
  public InteractionType convertToEntityAttribute(String dbData) {
    ...
    return InteractionType.fromCode(dbData);
  }
}
