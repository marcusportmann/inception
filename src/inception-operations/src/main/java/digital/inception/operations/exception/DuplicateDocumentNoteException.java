 ...
 */
@Problem(
    type = "https://inception.digital/problems/operations/duplicate-document-note",
    title = "A document note with the specified ID already exists.",
    status = 409)
@WebFault(
    name = "DuplicateDocumentNoteException",
    targetNamespace = "https://inception.digital/operations",
    faultBean = "digital.inception.core.service.ServiceError")
@XmlAccessorType(XmlAccessType.PROPERTY)
public class DuplicateDocumentNoteException extends ServiceException {

  @Serial private static final long serialVersionUID = 1000000;

  /**
   * Constructs a new {@code DuplicateDocumentNoteException}.
   *
   * @param documentNoteId the ID for the document note
   */
  public DuplicateDocumentNoteException(UUID documentNoteId) {
    super("The document note (" + documentNoteId + ") already exists");
  }
}
