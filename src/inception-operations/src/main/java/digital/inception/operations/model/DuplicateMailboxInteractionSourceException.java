...
public class DuplicateMailboxInteractionSourceException extends ServiceException {
   ...
   */
  public DuplicateMailboxInteractionSourceException(String mailboxInteractionSourceId) {
    super("The mailbox interaction source (" + mailboxInteractionSourceId + ") already exists");
  }
}
