...
//
/// **
// * The {@code WorkflowStore} interface defines the functionality provided by a workflow store,
// which
...
//   */
//  void cancelWorkflow(UUID tenantId, UUID workflowId, String canceledBy, String
// cancellationReason)
...
//   * @throws WorkflowNotFoundException if the workflow could not be found
//   * @throws WorkflowInteractionLinkNotFoundException if the workflow interaction link could not
// be
//   *     found
//   * @throws ServiceUnavailableException if the interaction could not be delinked from the
// workflow
//   */
...
//   * @throws ServiceUnavailableException if the IDs for the active workflows for the workflow
// engine
...
//   *     retrieved
//   */
//  List<OutstandingWorkflowDocument> getOutstandingWorkflowDocuments(UUID tenantId, UUID
// workflowId)
//      throws WorkflowNotFoundException, ServiceUnavailableException;
//
//  /**
...
//   *     specified ID
//   * @throws WorkflowNotFoundException if the workflow could not be found
//   * @throws ServiceUnavailableException if the {@link WorkflowDefinitionId} (id + version) for
// the
...
//   */
//  WorkflowDocuments getWorkflowDocuments REMOVE??(
//      UUID tenantId,
//      UUID workflowId,
//      String filter,
...
//   * @throws WorkflowDocumentNotFoundException if the workflow document could not be found
//   * @throws ServiceUnavailableException if the workflow ID could not be retrieved for the
// workflow
//   *     document
//   */
...
//      UUID tenantId, RejectWorkflowDocumentRequest rejectWorkflowDocumentRequest, String
// rejectedBy)
//      throws WorkflowDocumentNotFoundException, ServiceUnavailableException;
//
//  /**
...
//      UUID tenantId, VerifyWorkflowDocumentRequest verifyWorkflowDocumentRequest, String
// verifiedBy)
//      throws WorkflowDocumentNotFoundException, ServiceUnavailableException;
//
//  /**
