...
/**
 * The {@code WorkflowInteractionLinkId} class implements the ID class for the {@code
 * WorkflowInteractionLink} class.
 *
 * @author Marcus Portmann
 */
@SuppressWarnings("unused")
public class WorkflowInteractionLinkId implements Serializable {
  ...
  public boolean equals(Object object) {
    ...
    WorkflowInteractionLinkId other = (WorkflowInteractionLinkId) object;
