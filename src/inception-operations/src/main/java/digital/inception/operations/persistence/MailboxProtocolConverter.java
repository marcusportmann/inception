...
/**
 * The <b>MailboxProtocolConverter</b> class implements the custom JPA converter for the
 * <b>MailboxProtocol</b> enumeration.
 *
 * @author Marcus Portmann
 */
@Converter(autoApply = true)
public class MailboxProtocolConverter implements AttributeConverter<MailboxProtocol, String> {

  /** Constructs a new <b>MailboxProtocolConverter</b>. */
  public MailboxProtocolConverter() {}
   ...
   */
  @Override
  public String convertToDatabaseColumn(MailboxProtocol attribute) {
    if (attribute == null) {
      return null;
    }
   ...
   */
  @Override
  public MailboxProtocol convertToEntityAttribute(String dbData) {
    if (dbData == null) {
      return null;
    }
    return MailboxProtocol.fromCode(dbData);
  }
}
