...
/**
 * The <b>ValidUpdateWorkflowRequest</b> annotation implements the custom constraint annotation used
...
public @interface ValidUpdateWorkflowRequest {
  ...
  String message() default
      "{digital.inception.operations.constraint.ValidUpdateWorkflowRequest.invalidUpdateWorkflowRequest.message}";
