...
/**
 * The <b>ProcessSummary</b> class holds the summary information for a process.
 *
 * @author Marcus Portmann
 */
@Schema(description = "A process summary")
...
@XmlRootElement(name = "ProcessSummary", namespace = "https://inception.digital/operations")
@XmlType(
    name = "ProcessSummary",
...
public class ProcessSummary implements Serializable {
  ...
  /** Constructs a new <b>ProcessSummary</b>. */
  ...
  public boolean equals(Object object) {
    ...
    ProcessSummary other = (ProcessSummary) object;
