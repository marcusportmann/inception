...
import digital.inception.operations.model.UpdateCaseRequest;
import java.time.OffsetDateTime;
import java.util.UUID;

/**
 * The <b>IDocumentService</b> interface defines the functionality provided by a Document Service
 * implementation.
 *
