...
/**
 * The <b>DuplicateProcessDefinitionException</b> exception is thrown to indicate an error condition as
 * a result of an attempt to create a duplicate process definition, i.e. a process definition with the
...
@Problem(
    type =
        "https://ceb.discovery.co.za/problems/business/shared/operations/duplicate-process-definition",
...
public class DuplicateProcessDefinitionException extends ServiceException {
  ...
  public DuplicateProcessDefinitionException(String processDefinitionId) {
    super("The process definition (" + processDefinitionId + ") already exists");
  }
}
