...
/**
 * The {@code WorkflowAttributeDefinitionId} class implements the ID class for the {@code
 * WorkflowAttributeDefinition} class.
 *
 * @author Marcus Portmann
 */
@SuppressWarnings("unused")
public class WorkflowAttributeDefinitionId implements Serializable {
  ...
  public boolean equals(Object object) {
    ...
    WorkflowAttributeDefinitionId other = (WorkflowAttributeDefinitionId) object;
