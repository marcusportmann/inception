...
/**
 * The {@code WorkflowFormTypeListAttributeConverter} class implements the custom JPA converter used
 * to store a list of {@code WorkflowFormType} instances as a String.
 *
 * @author Marcus Portmann
 */
@Converter(autoApply = true)
public class WorkflowFormTypeListAttributeConverter
    implements AttributeConverter<List<WorkflowFormType>, String> {

  /** Constructs a new {@code WorkflowFormTypeListAttributeConverter}. */
  public WorkflowFormTypeListAttributeConverter() {}
   ...
   */
  @Override
  public String convertToDatabaseColumn(List<WorkflowFormType> attribute) {
    if (attribute == null || attribute.isEmpty()) {
      return null;
    }

    StringJoiner joiner = new StringJoiner(",");
    for (WorkflowFormType requiredDocumentAttribute : attribute) {
   ...
   */
  @Override
  public List<WorkflowFormType> convertToEntityAttribute(String dbData) {
