 ...
 */
@Schema(description = "The results of a request to retrieve a list of workflow notes")
...
public class WorkflowNotes implements Serializable {
  ...
  /** The method used to sort the workflow notes e.g. by captured at. */
  @Schema(description = "The method used to sort the workflow notes e.g. by captured at")
  @JsonProperty
   ...
   * @param sortBy the method used to sort the workflow notes e.g. by captured at
  ...
  /**
   * Returns the method used to sort the workflow notes e.g. by captured at.
   *
