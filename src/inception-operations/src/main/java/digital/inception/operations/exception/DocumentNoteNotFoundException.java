...
/**
 * The {@code DocumentNoteNotFoundException} exception is thrown to indicate an error condition as a
 * result of a document note that could not be found.
 *
 ...
 */
@Problem(
    type = "https://inception.digital/problems/operations/document-note-not-found",
    title = "The document note could not be found.",
    status = 404)
@WebFault(
    name = "DocumentNoteNotFoundException",
    targetNamespace = "https://inception.digital/operations",
    faultBean = "digital.inception.core.service.ServiceError")
@XmlAccessorType(XmlAccessType.PROPERTY)
public class DocumentNoteNotFoundException extends ServiceException {
