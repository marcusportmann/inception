...
/**
 * The <b>InteractionStatusConverter</b> class implements the custom JPA converter for the
 * <b>InteractionStatus</b> enumeration.
 *
...
public class InteractionStatusConverter implements AttributeConverter<InteractionStatus, String> {
  ...
  /** Constructs a new <b>InteractionStatusConverter</b>. */
  public InteractionStatusConverter() {}
  ...
  public InteractionStatus convertToEntityAttribute(String dbData) {
    ...
    return InteractionStatus.fromCode(dbData);
  }
}
