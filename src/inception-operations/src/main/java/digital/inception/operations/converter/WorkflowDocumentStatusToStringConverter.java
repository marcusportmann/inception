...
/**
 * The <b>WorkflowDocumentStatusToStringConverter</b> class implements the Spring converter that
 * converts a <b>WorkflowDocumentStatus</b> type into a <b>String</b> type.
 *
...
public class WorkflowDocumentStatusToStringConverter implements Converter<WorkflowDocumentStatus, String> {
  ...
  @Override
  public String convert(WorkflowDocumentStatus source) {
    return source.code();
  }
}
