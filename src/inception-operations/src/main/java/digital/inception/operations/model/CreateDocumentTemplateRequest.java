...
/**
 * The {@code CreateDocumentTemplateRequest} class represents a request to create a document
 * template.
 *
 * @author Marcus Portmann
 */
@Schema(description = "A request to create a document template")
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonPropertyOrder({"id", "categoryId", "tenantId", "name", "description", "data"})
@XmlRootElement(
    name = "CreateDocumentTemplateRequest",
...
public class CreateDocumentTemplateRequest implements Serializable {
  ...
  /** Constructs a new {@code CreateDocumentTemplateRequest}. */
