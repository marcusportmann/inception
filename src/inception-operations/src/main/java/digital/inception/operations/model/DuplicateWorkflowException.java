...
public class DuplicateWorkflowException extends ServiceException {
   ...
   */
  public DuplicateWorkflowException(UUID workflowId) {
    super("The workflow (" + workflowId + ") already exists");
  }
}
