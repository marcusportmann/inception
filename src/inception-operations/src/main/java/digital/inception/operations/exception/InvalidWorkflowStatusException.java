...
/**
 * The {@code InvalidWorkflowStatusException} exception is thrown to indicate that the status of the
 * workflow is invalid for the requested operation.
 *
...
@Problem(
    ...
    title = "The status of the workflow is invalid for the requested operation",
    status = 409)
@WebFault(
    name = "InvalidWorkflowStatusException",
    targetNamespace = "https://inception.digital/operations",
    faultBean = "digital.inception.core.service.ServiceError")
@XmlAccessorType(XmlAccessType.PROPERTY)
public class InvalidWorkflowStatusException extends ServiceException {

  @Serial private static final long serialVersionUID = 1000000;

  /**
   * Constructs a new {@code InvalidWorkflowStatusException}.
   *
