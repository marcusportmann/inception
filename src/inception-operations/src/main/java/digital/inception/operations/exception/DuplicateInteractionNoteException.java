 ...
 */
@Problem(
    type = "https://inception.digital/problems/operations/duplicate-interaction-note",
    title = "A interaction note with the specified ID already exists.",
    status = 409)
@WebFault(
    name = "DuplicateInteractionNoteException",
    targetNamespace = "https://inception.digital/operations",
    faultBean = "digital.inception.core.service.ServiceError")
@XmlAccessorType(XmlAccessType.PROPERTY)
public class DuplicateInteractionNoteException extends ServiceException {

  @Serial private static final long serialVersionUID = 1000000;

  /**
   * Constructs a new {@code DuplicateInteractionNoteException}.
   *
   * @param interactionNoteId the ID for the interaction note
   */
  public DuplicateInteractionNoteException(UUID interactionNoteId) {
    super("The interaction note (" + interactionNoteId + ") already exists");
  }
}
