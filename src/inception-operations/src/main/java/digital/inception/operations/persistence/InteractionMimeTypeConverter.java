...
/**
 * The <b>InteractionMimeTypeConverter</b> class implements the custom JPA converter for the
 * <b>InteractionMimeType</b> enumeration.
 *
 * @author Marcus Portmann
 */
@Converter(autoApply = true)
public class InteractionMimeTypeConverter
    implements AttributeConverter<InteractionMimeType, String> {

  /** Constructs a new <b>InteractionMimeTypeConverter</b>. */
  public InteractionMimeTypeConverter() {}
   ...
   */
  @Override
  public String convertToDatabaseColumn(InteractionMimeType attribute) {
    if (attribute == null) {
      return null;
    }
   ...
   */
  @Override
  public InteractionMimeType convertToEntityAttribute(String dbData) {
    if (dbData == null) {
      return null;
    }
    return InteractionMimeType.fromCode(dbData);
  }
}
