...
/**
 * The <code>GroupMemberTypeConverter</code> class implements the custom JPA converter for the
 * <code>GroupMemberType</code> enumeration.
 *
...
public class GroupMemberTypeConverter
   ...
   */
  @Override
  public Integer convertToDatabaseColumn(GroupMemberType attribute) {
   ...
   */
  @Override
  public GroupMemberType convertToEntityAttribute(Integer dbData) {
    return GroupMemberType.fromCode(dbData);
  }
}
