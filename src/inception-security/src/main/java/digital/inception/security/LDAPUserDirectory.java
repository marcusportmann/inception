  ...
  public LDAPUserDirectory(UUID userDirectoryId, List<UserDirectoryParameter> parameters,
    ...
    try {
      if (UserDirectoryParameter.contains(parameters, "Host")) {
        ...
        throw new SecurityServiceException("No Host parameter found for the user directory ("
            + userDirectoryId + ")");
      }
      ...
      if (UserDirectoryParameter.contains(parameters, "Port")) {
        ...
        throw new SecurityServiceException("No Port parameter found for the user directory ("
            + userDirectoryId + ")");
      }
      ...
      if (UserDirectoryParameter.contains(parameters, "BindDN")) {
        ...
        throw new SecurityServiceException("No BindDN parameter found for the user directory ("
            + userDirectoryId + ")");
      }
      ...
      if (UserDirectoryParameter.contains(parameters, "UserBaseDN")) {
        ...
        throw new SecurityServiceException("No UserBaseDN parameter found for the user directory ("
            + userDirectoryId + ")");
      }
      ...
      if (UserDirectoryParameter.contains(parameters, "UserUsernameAttribute")) {
        ...
        throw new SecurityServiceException(
            "No UserUsernameAttribute parameter found for the user directory (" + userDirectoryId
                + ")");
      }
      ...
      if (UserDirectoryParameter.contains(parameters, "UserFirstNameAttribute")) {
        ...
        throw new SecurityServiceException(
            "No UserFirstNameAttribute parameter found for the user directory (" + userDirectoryId
                + ")");
      }
      ...
      if (UserDirectoryParameter.contains(parameters, "UserLastNameAttribute")) {
        ...
        throw new SecurityServiceException(
            "No UserLastNameAttribute parameter found for the user directory (" + userDirectoryId
                + ")");
      }
      ...
      if (UserDirectoryParameter.contains(parameters, "UserFullNameAttribute")) {
        ...
        throw new SecurityServiceException(
            "No UserFullNameAttribute parameter found for the user directory (" + userDirectoryId
                + ")");
      }
      ...
      if (UserDirectoryParameter.contains(parameters, "UserEmailAttribute")) {
        ...
        throw new SecurityServiceException(
            "No UserEmailAttribute parameter found for the user directory (" + userDirectoryId
                + ")");
      }
      ...
      if (UserDirectoryParameter.contains(parameters, "GroupNameAttribute")) {
        ...
        throw new SecurityServiceException(
            "No GroupNameAttribute parameter found for the user directory (" + userDirectoryId
                + ")");
      }
      ...
      if (UserDirectoryParameter.contains(parameters, "GroupMemberAttribute")) {
        ...
        throw new SecurityServiceException(
            "No GroupMemberAttribute parameter found for the user directory (" + userDirectoryId
                + ")");
      }
      ...
      if (UserDirectoryParameter.contains(parameters, "SupportsAdminChangePassword")) {
        supportsAdminChangePassword = UserDirectoryParameter.getBooleanValue(parameters,
      ...
      if (UserDirectoryParameter.contains(parameters, "SupportsChangePassword")) {
        supportsChangePassword = UserDirectoryParameter.getBooleanValue(parameters,
      ...
      if (UserDirectoryParameter.contains(parameters, "SupportsGroupAdministration")) {
        supportsGroupAdministration = UserDirectoryParameter.getBooleanValue(parameters,
      ...
      if (UserDirectoryParameter.contains(parameters, "SupportsGroupMemberAdministration")) {
        supportsGroupMemberAdministration = UserDirectoryParameter.getBooleanValue(parameters,
      ...
      if (UserDirectoryParameter.contains(parameters, "SupportsUserAdministration")) {
        supportsUserAdministration = UserDirectoryParameter.getBooleanValue(parameters,
            "SupportsUserAdministration");
      }

      capabilities = new UserDirectoryCapabilities(supportsAdminChangePassword,
          supportsChangePassword, supportsGroupAdministration, supportsGroupMemberAdministration,
          false, false, supportsUserAdministration, false);
    } catch (Throwable e) {
...
//  }
  ...
  public void createGroup(Group group)
    ...
    try {
      ...
      if (groupDN != null) {
        ...
        groupDN = new LdapName(groupNameAttribute + "=" + group.getName() + ","
            + groupBaseDN.toString());
      }
  ...
  public void deleteUser(String username)
    ...
    try {
      ...
      while (searchResults.hasMore()) {
        ...
        if (attribute.size() > 0) {
          dirContext.modifyAttributes(new LdapName(searchResult.getNameInNamespace()),
    ...
    try {
      ...
      while (searchResults.hasMore()) {
        ...
        if (searchResult.getAttributes().get(groupNameAttribute) != null) {
          groupNames.add(String.valueOf(searchResult.getAttributes().get(groupNameAttribute).get())
              .toLowerCase());
        }
      }
      ...
      return getGroupRepository().getFunctionCodesByUserDirectoryIdAndGroupNames(
          getUserDirectoryId(), groupNames);
    } catch (UserNotFoundException e) {
      throw e;
    } catch (Throwable e) {
  ...
  public List<Group> getGroups(String filter, SortDirection sortDirection, Integer pageIndex,
    ...
    try {
      ...
      if (StringUtils.isEmpty(filter)) {
        ...
        searchFilter = String.format("(&(objectClass=%s)(%s=*%s*))", groupObjectClass,
            groupNameAttribute, filter);
      }
  ...
  public List<GroupMember> getMembersForGroup(String groupName)
    ...
    try {
          ...
          for (int i = 0; ((i < attribute.size()) && (i < maxFilteredGroupMembers)); i++) {
            ...
            for (Rdn rdn : groupMemberDn.getRdns()) {
              if (rdn.getType().equalsIgnoreCase(userUsernameAttribute)) {
                groupMembers.add(new GroupMember(getUserDirectoryId(), groupName, GroupMemberType
                    .USER, String.valueOf(rdn.getValue())));
      ...
      throw new SecurityServiceException("Failed to retrieve the members for the group ("
          + groupName + ") for the user directory (" + getUserDirectoryId() + ")", e);
    } finally {
      JNDIUtil.close(searchResults);
      JNDIUtil.close(dirContext);
    ...
    try {
      ...
      if (searchResults.hasMore()) {
              ...
              if (rdn.getType().equalsIgnoreCase(userUsernameAttribute)) {
                if (StringUtils.isEmpty(filter)) {
                  ...
                  if (username.contains(filter)) {
                    groupMembers.add(new GroupMember(getUserDirectoryId(), groupName,
                        GroupMemberType.USER, String.valueOf(rdn.getValue())));
                  }
                }
        ...
        if (sortDirection == SortDirection.ASCENDING) {
          ...
          groupMembers.sort((GroupMember groupMember1,
              GroupMember groupMember2) -> groupMember2.getMemberName().compareTo(
              groupMember1.getMemberName()));
        }
      ...
      throw new SecurityServiceException("Failed to retrieve the filtered members for the group ("
          + groupName + ") for the user directory (" + getUserDirectoryId() + ")", e);
    } finally {
      JNDIUtil.close(searchResults);
      JNDIUtil.close(dirContext);
  ...
  public long getNumberOfMembersForGroup(String groupName, String filter)
    ...
    try {
      ...
      throw new SecurityServiceException(
          "Failed to retrieve the number of filtered members for the group (" + groupName
              + ") for the user directory (" + getUserDirectoryId() + ")", e);
    } finally {
      JNDIUtil.close(searchResults);
      JNDIUtil.close(dirContext);
  ...
  public List<String> getRoleCodesForUser(String username)
    ...
    try {
      ...
      return getGroupRepository().getRoleCodesByUserDirectoryIdAndGroupNames(getUserDirectoryId(),
          groupNames);
    } catch (UserNotFoundException e) {
      throw e;
    } catch (Throwable e) {
  ...
  public List<User> getUsers(String filter, UserSortBy sortBy, SortDirection sortDirection,
    ...
    try {
      ...
      if (sortDirection == SortDirection.ASCENDING) {
        ...
        if (sortBy == UserSortBy.USERNAME) {
          users.sort((User user1, User user2) -> user2.getUsername().compareTo(
              user1.getUsername()));
        } else if (sortBy == UserSortBy.FIRST_NAME) {
          users.sort((User user1, User user2) -> user2.getFirstName().compareTo(
              user1.getFirstName()));
        } else if (sortBy == UserSortBy.LAST_NAME) {
          users.sort((User user1, User user2) -> user2.getLastName().compareTo(
              user1.getLastName()));
        }
      }
  ...
  private User buildUserFromSearchResult(SearchResult searchResult)
    ...
    if ((!StringUtils.isEmpty(userEmailAttribute)) && (attributes.get(userEmailAttribute)
        != null)) {
