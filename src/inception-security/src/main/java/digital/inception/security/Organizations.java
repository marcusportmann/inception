...
/**
 * The <code>Organizations</code> class holds the results of a request to retrieve a list of group
 * members.
 *
 * @author Marcus Portmann
 */
@Schema(description = "Organizations")
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonPropertyOrder({"organizations", "total", "filter", "sortDirection", "pageIndex", "pageSize"})
@XmlRootElement(name = "Organizations", namespace = "http://security.inception.digital")
@XmlType(
    name = "Organizations",
...
public class Organizations implements Serializable {
   ...
   * Constructs a new <code>Organizations</code>.
   *
   * @param organizations tbe organizations
