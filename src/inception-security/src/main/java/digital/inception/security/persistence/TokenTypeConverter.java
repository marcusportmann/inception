...
/**
 * The <b>TokenTypeConverter</b> class implements the custom JPA converter for the <b>TokenType</b>
 * enumeration.
 *
...
public class TokenTypeConverter implements AttributeConverter<TokenType, String> {
  ...
  /** Constructs a new <b>TokenTypeConverter</b>. */
  ...
  public TokenType convertToEntityAttribute(String dbData) {
    ...
    return TokenType.fromCode(dbData);
  }
}
