 ...
 */
@ResponseStatus(value = HttpStatus.NOT_FOUND, reason = "The organisation could not be found")
...
public class OrganisationNotFoundException extends Exception
{
  ...
  /**
   * Constructs a new <code>OrganisationNotFoundException</code>.
   *
  ...
  {
    super(String.format("The organisation (%s) could not be found", organisationId));
  }
}
