...
@javax.xml.bind.annotation.XmlSchema(namespace = "http://messaging.inception.digital",
    ...
    xmlns = { @javax.xml.bind.annotation.XmlNs(prefix = "core",
        ...
        @javax.xml.bind.annotation.XmlNs(prefix = "messaging",
            namespaceURI = "http://messaging.inception.digital") , })
