...
/**
 * The <b>CodesApiController</b> class.
 *
...
public class CodesApiController extends SecureApiController implements ICodesApiController {

  /** The Codes Service. */
  private final ICodesService codesService;

  /**
   * Constructs a new <b>CodesApiController</b>.
   *
   * @param applicationContext the Spring application context
   * @param codesService the Codes Service
   */
  public CodesApiController(ApplicationContext applicationContext, ICodesService codesService) {
