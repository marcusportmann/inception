...
/**
 * The <code>DuplicateVehicleException</code> exception is thrown to indicate an error condition as
 * a result of an attempt to create a duplicate vehicle.
 *
...
public class DuplicateVehicleException extends ServiceException {
  ...
  /**
   * Constructs a new <code>DuplicateVehicleException</code>.
   *
