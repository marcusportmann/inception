...
COMMENT ON COLUMN error.error_reports.id IS 'The Universally Unique Identifier (UUID) for the error report';

COMMENT ON COLUMN error.error_reports.application_id IS 'The ID for the application that generated the error report';
...
COMMENT ON COLUMN error.error_reports.who IS 'The optional username for the user associated with the error report';

COMMENT ON COLUMN error.error_reports.device_id IS 'The optional Universally Unique Identifier (UUID) for the device the error report originated from';
