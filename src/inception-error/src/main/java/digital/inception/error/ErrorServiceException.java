...
/**
 * The <b>ErrorServiceException</b> exception is thrown to indicate an error condition when
...
public class ErrorServiceException extends ServiceException {
  ...
  /**
   * Constructs a new <b>ErrorServiceException</b> with the specified message.
   *
  ...
  /**
   * Constructs a new <b>ErrorServiceException</b> with the specified message and cause.
   *
   * @param message The message saved for later retrieval by the <b>getMessage()</b> method.
