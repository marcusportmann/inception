...
public class ProblemHandler {
  ...
  protected ResponseEntity<ProblemDetails> handle(
    ...
    if (problem != null) {
      ...
      problemDetails.setType("http://inception.digital/problems/service-unavailable");
   ...
   * @return the problem details response entity containing the /NarayanaTransactionIntegrationexception information
   */
  @ExceptionHandler
  @ResponseBody
