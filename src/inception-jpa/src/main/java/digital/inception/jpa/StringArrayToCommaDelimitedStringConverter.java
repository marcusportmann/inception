...
/**
 * The <b>StringArrayToCommaDelimitedStringConverter</b> class implements the custom JPA converter
 * to store an array of strings as a comma-delimited string.
 *
 * @author Marcus Portmann
 */
@Converter(autoApply = true)
public class StringArrayToCommaDelimitedStringConverter
    implements AttributeConverter<String[], String> {

  /** Constructs a new <b>StringArrayToCommaDelimitedStringConverter</b>. */
  public StringArrayToCommaDelimitedStringConverter() {}
