...
/**
 * The <b>ValidationSchemaTypeConverter</b> class implements the custom JPA converter for the
 * <b>ValidationSchemaType</b> enumeration.
 *
 * @author Marcus Portmann
 */
@Converter(autoApply = true)
public class ValidationSchemaTypeConverter
    implements AttributeConverter<ValidationSchemaType, String> {

  /** Constructs a new <b>ValidationSchemaTypeConverter</b>. */
  public ValidationSchemaTypeConverter() {}
   ...
   */
  @Override
  public String convertToDatabaseColumn(ValidationSchemaType attribute) {
    if (attribute == null) {
      return null;
    }
   ...
   */
  @Override
  public ValidationSchemaType convertToEntityAttribute(String dbData) {
    if (dbData == null) {
      return null;
    }
    return ValidationSchemaType.fromCode(dbData);
  }
}
