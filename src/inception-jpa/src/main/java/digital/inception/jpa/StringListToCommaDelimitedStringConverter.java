...
/**
 * The <b>StringListToCommaDelimitedStringConverter</b> class implements the custom JPA converter to
 * store a list of strings as a comma-delimited string.
 *
 * @author Marcus Portmann
 */
@Converter(autoApply = true)
public class StringListToCommaDelimitedStringConverter
    implements AttributeConverter<List<String>, String> {

  /** Constructs a new <b>StringListToCommaDelimitedStringConverter</b>. */
  public StringListToCommaDelimitedStringConverter() {}
