...
@javax.xml.bind.annotation.XmlSchema(namespace = "http://scheduler.inception.digital",
    ...
    xmlns = {@javax.xml.bind.annotation.XmlNs(prefix = "core",
        ...
        @javax.xml.bind.annotation.XmlNs(prefix = "scheduler",
            namespaceURI = "http://scheduler.inception.digital"),})
