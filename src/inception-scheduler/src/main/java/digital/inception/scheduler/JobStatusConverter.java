...
/**
 * The <code>JobStatusConverter</code> class implements the custom JPA converter for the
 * <code>JobStatus</code> enumeration.
 *
...
public class JobStatusConverter
  implements AttributeConverter<JobStatus, Integer>
{
  /**
