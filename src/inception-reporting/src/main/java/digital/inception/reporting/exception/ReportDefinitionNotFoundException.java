...
package digital.inception.reporting.exception;
...
/**
 * The {@code ReportDefinitionNotFoundException} exception is thrown to indicate an error condition
...
public class ReportDefinitionNotFoundException extends ServiceException {
  ...
  /**
   * Creates a new {@code ReportDefinitionNotFoundException} instance.
   *
