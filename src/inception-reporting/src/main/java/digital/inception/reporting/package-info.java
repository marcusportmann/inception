...
@javax.xml.bind.annotation.XmlSchema(namespace = "http://reporting.inception.digital",
    ...
    xmlns = { @javax.xml.bind.annotation.XmlNs(prefix = "core",
        ...
        @javax.xml.bind.annotation.XmlNs(prefix = "reporting",
            namespaceURI = "http://reporting.inception.digital") , })
