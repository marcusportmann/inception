  ...
  implements TemplateLoader
{
   ...
   *
   * @param name The name of the template, already localized and normalized by the
   *             {@link freemarker.cache.TemplateCache cache}.
   *
   ...
   * {@link Reader}, and it must not use it anymore. That is, this method is not required to support
   ...
   * parameter used doesn't match the actual template content (based on the
   ...
   * @param encoding       the character encoding used to translate source bytes to characters.
   *                       Some loaders may not have access to the byte representation of the
   *                       template stream, and instead directly obtain a character stream. These
