...
public class MailTemplateContentTypeConverter
    implements AttributeConverter<MailTemplateContentType, String> {

  /** Constructs a new <b>MailTemplateContentTypeConverter</b>. */
  public MailTemplateContentTypeConverter() {}
   ...
   */
  @Override
  public String convertToDatabaseColumn(MailTemplateContentType attribute) {
    if (attribute == null) {
      return null;
    }
   ...
   */
  @Override
  public MailTemplateContentType convertToEntityAttribute(String dbData) {
    if (dbData == null) {
      return null;
    }
