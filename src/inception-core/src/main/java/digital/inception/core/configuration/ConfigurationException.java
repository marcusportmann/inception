...
public class ConfigurationException extends RuntimeException {
  ...
  /** Creates a new {@code ConfigurationException} instance with {@code null} as its message. */
  public ConfigurationException() {
    super();
  }

  /**
   * Creates a new {@code ConfigurationException} instance with the specified message.
   *
  ...
  /**
   * Creates a new {@code ConfigurationException} instance with the specified message and cause.
   *
   * @param message The message saved for later retrieval by the {@code getMessage()} method.
