...
public class ProblemDetails {
  ...
  /**
   * Sets the error code associated with the problem.
   *
  ...
  /**
   * Sets the name of the parameter associated with the problem.
   *
  ...
  /**
   * Sets the stack trace generated by the origin server for the problem.
   *
  ...
  /**
   * Sets the HTTP status code generated by the origin server for this occurrence of the problem.
   *
  ...
  /**
   * Sets the date and time the problem occurred.
   *
  ...
  /**
   * Sets the validation errors associated with the problem.
   *
