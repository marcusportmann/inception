...
public class Base64Util {
  ...
  /**
   * Decodes data from Base64Util notation and returns it as a string. Equivlaent to calling
   ...
   * <p/>
   * This method returns the actual number of bytes that were converted from the Base64Util
   * encoding.
   *
