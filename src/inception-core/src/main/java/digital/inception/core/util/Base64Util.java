...
public class Base64Util
{
  ...
  public static byte[] decode(byte[] source, int off, int len)
  {
    ...
    for (i = off; i < off + len; i++)
    {
      ...
      {
        throw new Base64Exception("Bad Base64Util input character at " + i + ": " + source[i]
            + "(decimal)");
      }
    }
  ...
  /**
   * Attempts to decode Base64Util data and deserialize a Java Object within. Returns <tt>null if there
   * was an error.
   *
  ...
  /**
   * Decodes data from Base64Util notation and returns it as a string.
  ...
  /**
   * Encodes a string in Base64Util notation with line breaks after every 75 Base64Util characters. Of
   ...
   * <p/>
   * This method returns the actual number of bytes that were converted from the Base64Util encoding.
   *
  ...
  /**
   * Encodes up to three bytes of the array <var>source</var> and writes the resulting four Base64Util
