...
/**
 * The <b>SafeString</b> annotation implements the custom constraint annotation used to apply the
 * string validation, which detects whether a <b>String</b> or the <b>String</b> properties of an
 * object contain unsafe script or SQL injection content.
 *
