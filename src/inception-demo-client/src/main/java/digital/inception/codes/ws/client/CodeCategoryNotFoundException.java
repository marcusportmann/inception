 ...
 * 2025-02-12T10:46:22.702+02:00
 * Generated source version: 4.0.2
 */

@WebFault(name = "CodeCategoryNotFoundException", targetNamespace = "https://inception.digital/codes")
public class CodeCategoryNotFoundException extends Exception {
    ...
    public CodeCategoryNotFoundException(String message, digital.inception.core.ws.client.ServiceError codeCategoryNotFoundException) {
        super(message);
        this.faultInfo = codeCategoryNotFoundException;
    }

    public CodeCategoryNotFoundException(String message, digital.inception.core.ws.client.ServiceError codeCategoryNotFoundException, java.lang.Throwable cause) {
        super(message, cause);
        this.faultInfo = codeCategoryNotFoundException;
    }
