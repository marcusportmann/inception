...
public class ObjectFactory {
     ...
     */
    @XmlElementDecl(namespace = "https://inception.digital/codes", name = "CreateCodeCategoryResponse")
     ...
     */
    @XmlElementDecl(namespace = "https://inception.digital/codes", name = "DeleteCodeCategoryResponse")
     ...
     */
    @XmlElementDecl(namespace = "https://inception.digital/codes", name = "GetCodeCategoryDataResponse")
     ...
     */
    @XmlElementDecl(namespace = "https://inception.digital/codes", name = "GetCodeCategoryLastModified")
     ...
     */
    @XmlElementDecl(namespace = "https://inception.digital/codes", name = "GetCodeCategoryLastModifiedResponse")
     ...
     */
    @XmlElementDecl(namespace = "https://inception.digital/codes", name = "GetCodeCategoryNameResponse")
     ...
     */
    @XmlElementDecl(namespace = "https://inception.digital/codes", name = "GetCodeCategorySummariesResponse")
     ...
     */
    @XmlElementDecl(namespace = "https://inception.digital/codes", name = "UpdateCodeCategoryResponse")
