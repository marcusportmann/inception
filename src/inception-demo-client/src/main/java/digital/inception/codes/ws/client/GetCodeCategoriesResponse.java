...
/**
 * Java class for GetCodeCategoriesResponse complex type.
 *
...
@XmlType(
    name = "GetCodeCategoriesResponse",
...
public class GetCodeCategoriesResponse implements Serializable {
   ...
   * object. This is why there is not a <CODE>set</CODE> method for the codeCategory property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link CodeCategory }
   */
