...
export class NewUserComponent extends AdminContainerView implements AfterViewInit {
  ...
  constructor(private router: Router, private activatedRoute: ActivatedRoute, private securityService: SecurityService,
    ...
    this.emailFormControl = new FormControl('', [Validators.maxLength(100), Validators.pattern(// eslint-disable-next-line max-len
    ...
    // eslint-disable-next-line max-len
    this.mobileNumberFormControl = new FormControl('', [Validators.maxLength(100), Validators.pattern(// eslint-disable-next-line max-len
