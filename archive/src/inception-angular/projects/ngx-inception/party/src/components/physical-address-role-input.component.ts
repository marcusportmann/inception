...
@Component({
  ...
  selector: 'physical-address-role-input',
  template: `
  ...
  providers: [
    {
      ...
      useExisting: PhysicalAddressRoleInputComponent
    }
  ]
})
export class PhysicalAddressRoleInputComponent implements MatFormFieldControl<string>,
   ...
   */
  filteredOptions$: BehaviorSubject<PhysicalAddressRole[]> = new BehaviorSubject<PhysicalAddressRole[]>([]);
  ...
  /**
   * The physical address role options.
   */
  private _options: PhysicalAddressRole[] = [];

  /**
   * The code for the party type to retrieve the physical address roles for.
   */
  ...
  /**
   * The code for the selected physical address role.
   */
  private _value: string | null = null;

  /**
   * Returns the code for the selected physical address role.
   *
   * @return The code for the selected physical address role.
   */
  ...
  /**
   * Set the code for the selected physical address role.
   *
   * @param value the code for the selected physical address role
   */
  @Input()
