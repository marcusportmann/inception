...
@Entity
@Table(schema = "party", name = "industry_classification_categories")
...
public class IndustryClassificationCategory implements Serializable {
  ...
  @Schema(description = "The code for the industry classification category", required = true)
  ...
  @Schema(description = "The description for the industry classification category", required = true)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The name of the industry classification category", required = true)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The sort index for the industry classification category", required = true)
  @JsonProperty(required = true)
