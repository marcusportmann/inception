...
/**
 * The <b>LinkType</b> class holds the information for a link type.
 *
...
@XmlRootElement(name = "LinkType", namespace = "http://inception.digital/party")
@XmlType(
    name = "LinkType",
...
@Entity
@Table(schema = "party", name = "link_types")
@IdClass(LinkTypeId.class)
public class LinkType implements Serializable {
  ...
  @Schema(description = "The description for the link type", required = true)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The Unicode locale identifier for the link type", required = true)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The name of the link type", required = true)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The sort index for the link type", required = true)
  @JsonProperty(required = true)
  ...
  /**
   * Returns the description for the link type.
   *
   * @return the description for the link type
   */
  ...
  /**
   * Returns the Unicode locale identifier for the link type.
   *
   * @return the Unicode locale identifier for the link type
   */
  ...
  /**
   * Returns the ID for the tenant the link type is specific to.
   *
   * @return the ID for the tenant the link type is specific to
   */
