...
@XmlRootElement(name = "IndustryClassificationSystem", namespace = "http://inception.digital/party")
@XmlType(
...
@Entity
@Table(schema = "party", name = "industry_classification_systems")
...
public class IndustryClassificationSystem implements Serializable {
  ...
  @Schema(description = "The description for the industry classification system", required = true)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The name of the industry classification system", required = true)
  @JsonProperty(required = true)
  ...
  @Schema(description = "The sort index for the industry classification system", required = true)
  @JsonProperty(required = true)
