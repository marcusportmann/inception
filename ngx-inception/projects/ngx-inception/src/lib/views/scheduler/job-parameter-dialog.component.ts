          ...
          <div class="col-sm">
            <mat-form-field>
              ...
              <mat-error *ngIf="nameFormControl.errors && !nameFormControl.untouched">
                <span *ngIf="nameFormControl.errors?.required" i18n="@@scheduler_job_parameter_dialog_component_error_name_required">
                  A name is required.
                </span>
                <span *ngIf="nameFormControl.errors?.maxlength" i18n="@@scheduler_job_parameter_dialog_component_error_name_maxlength">
          ...
          <div class="col-sm">
            <mat-form-field>
              ...
              <mat-error *ngIf="valueFormControl.errors && !valueFormControl.untouched">
                <span *ngIf="valueFormControl.errors?.maxlength" i18n="@@scheduler_job_parameter_dialog_component_error_value_maxlength">
...
export class JobParameterDialogComponent {
   ...
   */
  constructor(private dialogRef: MatDialogRef<JobParameterDialogComponent>, @Inject(MAT_DIALOG_DATA) private data: JobParameterDialogData) {
