...
import {InceptionConfig} from 'ngx-inception/lib/inception-config';
import {InceptionAppModule} from 'ngx-inception/lib/inception-app.module';
...
import {NavigationItem} from 'ngx-inception/lib/services/navigation/navigation-item';
import {NavigationBadge} from 'ngx-inception/lib/services/navigation/navigation-badge';
import {NavigationTitle} from 'ngx-inception/lib/services/navigation/navigation-title';
...
@NgModule({
  ...
  imports: [AppRoutingModule,
    ...
    InceptionModule.forRoot(ngxInceptionConfiguration)
  ],
  providers: [{
