...
import {CodeCategoriesTitleResolver} from 'ngx-inception/lib/views/codes/code-categories-title-resolver';
import {ConfigurationsTitleResolver} from 'ngx-inception/lib/views/configuration/configurations-title-resolver';
...
const routes: Routes = [{
  ...
  loadChildren: () => import('ngx-inception/lib/views/security/security.module').then(
    m => m.SecurityModule)
}, {
  path: 'system',
  resolve: {
  ...
  children: [{
    ...
    loadChildren: () => import('ngx-inception/lib/views/codes/codes.module').then(m => m.CodesModule)
  }, {
    path: 'configuration',
    resolve: {
      title: ConfigurationsTitleResolver
    },
    loadChildren: () => import('ngx-inception/lib/views/configuration/configuration.module').then(
...

    {
      ...
      loadChildren: () => import('ngx-inception/lib/views/mail/mail.module').then(m => m.MailModule)
    }, {
      path: 'scheduler',
      resolve: {
        title: SchedulerTitleResolver
      },
      loadChildren: () => import('ngx-inception/lib/views/scheduler/scheduler.module').then(
        m => m.SchedulerModule)
    }, {
      path: 'reporting',
      resolve: {
      ...
      loadChildren: () => import('ngx-inception/lib/views/reporting/reporting.module').then(
        m => m.ReportingModule)
    }
  ]
}
