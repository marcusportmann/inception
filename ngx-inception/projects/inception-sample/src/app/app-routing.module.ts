...
} from 'ngx-inception/lib/components/layout';
import {CanActivateFunctionGuard} from 'ngx-inception/lib/routing/can-activate-function-guard';
...
// Login route
  {
    ...
    loadChildren: () => import('ngx-inception/lib/views/login/login.module').then(m => m.LoginModule)
  },
...
// Send Error Report route
  {
    path: 'error',
    component: SimpleContainerComponent,
    loadChildren: () => import('ngx-inception/lib/views/error/error.module').then(m => m.ErrorModule)
  },
